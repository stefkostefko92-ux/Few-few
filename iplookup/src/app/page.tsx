    ...
    <div className="space-y-10">
      ...
      <section aria-labelledby="honesty" className="card border-warn p-5">
        ...
        <ul className="mt-3 space-y-2 text-sm text-text-muted">
          <li>
            <strong className="text-text">Не слагаме игличка върху град.</strong> Картата откроява цялата
            държава, защото толкова знаем: геолокацията по IP познава града в около две трети от случаите,
            и то „в рамките на 50 км“. Координатите, които виждаш, са на географския център на държавата и
            са надписани точно така. Един грешен център веднъж прати стотици милиони адреса към една ферма
            в Канзас — не повтаряме тази грешка.
          </li>
          <li>
...
const CAPABILITIES = [
  ...
  {
    title: "Активна проверка — само ако я поискаш",
    body: "По натискане на бутон проверяваме осем познати порта и четем сертификата на 443. Полето SAN в него често изброява домейните зад адреса — отговорът на „кой стои тук“, който никой регистър не дава.",
  },
];
