...
export const DEFAULT_SETTINGS = {
  ...
  webhooks: {
    ...
    discordUsername: 'Tanoth Bot',   // bot name shown in Discord
    discordAvatarUrl: '',            // https image URL for the bot avatar/thumbnail
...
export function mergeSettings(stored) {
  ...
  for (const section of Object.keys(out)) {
    ...
    } else if (stored[section] !== undefined && typeof out[section] !== 'object') {
      out[section] = stored[section];   // scalar sections only; never clobber a default object
    }
  }
