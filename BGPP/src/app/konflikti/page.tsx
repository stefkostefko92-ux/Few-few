          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600">
                ...
                Изпълнителните директори и членовете на бордовете на държавните
                дружества са „лица, заемащи висша публична длъжност“ (чл. 6 ЗПК) и
                подават декларация за имущество и интереси пред Сметната палата
                (публичен регистър register.cacbg.bg).
              </p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-5">
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-slate-600">
                ...
                <li>Сравни имената; при съвпадение виж декларацията за имущество и интереси на лицето в публичния регистър (register.cacbg.bg).</li>
                <li>Роднинството се потвърждава само с официален документ (декларация, акт на проверяващия орган, съдебен акт). Публичната част заличава лични данни, така че „свързаните лица“ невинаги са видими онлайн.</li>
              </ol>
            </div>
          </div>
