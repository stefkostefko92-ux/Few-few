      ...
      <section id="products" style={{position:"relative",zIndex:5,padding:"80px 20px 120px",borderTop:"1px solid rgba(245,245,240,.08)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:2,marginBottom:2}}>
          {[
            ...
            {name:"Evanita Sport",url:"https://evanita-bg.com",tag:"FITNESS · BG",desc:{it:"Studio femminile di Kangoo Jumps e allenamento di forza a Dupnitsa, con istruttrice qualificata.",en:"Women's studio for Kangoo Jumps and strength training in Dupnitsa, with a licensed instructor.",bg:"Дамско студио за Kangoo Jumps и силови тренировки в Дупница, с лицензиран инструктор."}},
            {name:"Eternal Touch",url:"https://eternaltouch.it",tag:"ATELIER · IT/BG",desc:{it:"Atelier a Bobov Dol: decorazioni in gesso fatte a mano, bomboniere e creazioni su misura. Tre donne, due paesi, una mano.",en:"Atelier in Bobov Dol: handmade plaster decorations, favours and bespoke creations. Three women, two countries, one hand.",bg:"Ателие в Бобов дол: ръчно изработени гипсови декорации, бонбониери и творения по поръчка. Три жени, две страни, една ръка."}},
