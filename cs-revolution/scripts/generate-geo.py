...
L = {
 "it": dict(
  ...
  desc="Sviluppo siti web, e-commerce e software per aziende di {name}. Da €790, preventivo gratuito in 24 ore. Parliamo italiano.",
  ...
  services=[("/servizi/sviluppo-siti-web/", "Sviluppo Siti Web", "da €1.890"), ("/servizi/ecommerce/", "E-Commerce", "da €2.190"), ("/servizi/sviluppo-software/", "Software su Misura", "da €2.000"), ("/servizi/erp/", "Sistemi ERP", "da €5.000"), ("/servizi/app-mobile/", "App Mobile", "da €3.000"), ("/servizi/seo/", "SEO / GEO / AEO", "da €290/mese"), ("/servizi/hosting/", "Hosting Cloud", "da €15/mese")],
  ...
  faq_cost=("Quanto costa un sito web a {name}?", "Un sito vetrina professionale parte da €1.890, un e-commerce da €2.190, software su misura da €2.000. Preventivo gratuito e dettagliato entro 24 ore."),
 ...
 "en": dict(
  ...
  desc="Websites, e-commerce and custom software for {name} businesses. From €790, free quote within 24 hours.",
  ...
  services=[("/en/services/web-development/", "Web Development", "from €1,890"), ("/en/services/ecommerce/", "E-Commerce", "from €2,190"), ("/en/services/software-development/", "Custom Software", "from €2,000"), ("/en/services/erp/", "ERP Systems", "from €5,000"), ("/en/services/mobile-apps/", "Mobile Apps", "from €3,000"), ("/en/services/seo/", "SEO / GEO / AEO", "from €290/mo"), ("/en/services/hosting/", "Cloud Hosting", "from €15/mo")],
  ...
  faq_cost=("How much does a website cost in {name}?", "A professional company website starts at €1,890, e-commerce at €2,190, custom software at €2,000. Free detailed quote within 24 hours."),
 ...
 "bg": dict(
  ...
  desc="Изработка на сайтове, онлайн магазини и софтуер за фирми в {name}. От €790, безплатна оферта до 24 часа.",
  ...
  services=[("/bg/uslugi/web-razrabotka/", "Уеб Разработка", "от €1890"), ("/bg/uslugi/ecommerce/", "Онлайн Магазини", "от €2190"), ("/bg/uslugi/softuer/", "Софтуер по Поръчка", "от €2000"), ("/bg/uslugi/erp/", "ERP Системи", "от €5000"), ("/bg/uslugi/mobilni-prilozheniya/", "Мобилни Приложения", "от €3000"), ("/bg/uslugi/seo/", "SEO / GEO / AEO", "от €290/мес"), ("/bg/uslugi/hosting/", "Облачен Хостинг", "от €15/мес")],
  ...
  faq_cost=("Колко струва изработката на сайт в {name}?", "Професионален фирмен сайт започва от €1890, онлайн магазин от €2190, софтуер по поръчка от €2000. Безплатна подробна оферта до 24 часа."),
