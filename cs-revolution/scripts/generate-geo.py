...
L = {
 "it": dict(
  ...
  desc="Sviluppo siti web, e-commerce e software per aziende di {name}. Da €658 + IVA, preventivo gratuito in 24 ore. Parliamo italiano.",
  ...
  services=[("/servizi/sviluppo-siti-web/", "Sviluppo Siti Web", "da €1.575 + IVA"), ("/servizi/ecommerce/", "E-Commerce", "da €1.825 + IVA"), ("/servizi/sviluppo-software/", "Software su Misura", "da €2.000"), ("/servizi/erp/", "Sistemi ERP", "da €5.000"), ("/servizi/app-mobile/", "App Mobile", "da €3.000"), ("/servizi/seo/", "SEO / GEO / AEO", "da €242/mese + IVA"), ("/servizi/hosting/", "Hosting Cloud", "da €13/mese + IVA")],
  ...
  faq_cost=("Quanto costa un sito web a {name}?", "Un sito vetrina professionale parte da €1.575 + IVA, un e-commerce da €1.825 + IVA, software su misura da €2.000. Preventivo gratuito e dettagliato entro 24 ore."),
 ...
 "en": dict(
  prefix="/en", urlbase="/en/geo/", og="og/og-geo-en.png", locale="en_US",
  ...
  desc="Websites, e-commerce and custom software for {name} businesses. From €658 + VAT, free quote within 24 hours.",
  ...
  services=[("/en/services/web-development/", "Web Development", "from €1,575 + VAT"), ("/en/services/ecommerce/", "E-Commerce", "from €1,825 + VAT"), ("/en/services/software-development/", "Custom Software", "from €2,000"), ("/en/services/erp/", "ERP Systems", "from €5,000"), ("/en/services/mobile-apps/", "Mobile Apps", "from €3,000"), ("/en/services/seo/", "SEO / GEO / AEO", "from €242/mo + VAT"), ("/en/services/hosting/", "Cloud Hosting", "from €13/mo + VAT")],
  ...
  faq_cost=("How much does a website cost in {name}?", "A professional company website starts at €1,575 + VAT, e-commerce at €1,825 + VAT, custom software at €2,000. Free detailed quote within 24 hours."),
 ...
 "bg": dict(
  prefix="/bg", urlbase="/bg/geo/", og="og/og-geo-bg.png", locale="bg_BG",
  ...
  desc="Изработка на сайтове, онлайн магазини и софтуер за фирми в {name}. От €790 с ДДС, безплатна оферта до 24 часа.",
  ...
  services=[("/bg/uslugi/web-razrabotka/", "Уеб Разработка", "от €1890 с ДДС"), ("/bg/uslugi/ecommerce/", "Онлайн Магазини", "от €2190 с ДДС"), ("/bg/uslugi/softuer/", "Софтуер по Поръчка", "от €2000"), ("/bg/uslugi/erp/", "ERP Системи", "от €5000"), ("/bg/uslugi/mobilni-prilozheniya/", "Мобилни Приложения", "от €3000"), ("/bg/uslugi/seo/", "SEO / GEO / AEO", "от €290/мес с ДДС"), ("/bg/uslugi/hosting/", "Облачен Хостинг", "от €15/мес с ДДС")],
  ...
  faq_cost=("Колко струва изработката на сайт в {name}?", "Професионален фирмен сайт започва от €1890 с ДДС, онлайн магазин от €2190 с ДДС, софтуер по поръчка от €2000. Безплатна подробна оферта до 24 часа."),
...
FT_ROW = {
 "it": '<p class="ft-links" style="margin-top:10px"><a href="/prezzi/">Prezzi</a> &middot; <a href="/portfolio/">Portfolio</a> &middot; <a href="/settori/">Settori</a> &middot; <a href="/geo/">Città</a> &middot; <a href="/servizi-locali/">Servizi locali</a> &middot; <a href="/blog/">Blog</a> &middot; <a href="/glossario/">Glossario</a> &middot; <a href="/confronti/">Confronti</a> &middot; <a href="/case-study/">Case study</a> &middot; <a href="/strumenti/">Strumenti</a></p>',
 "en": '<p class="ft-links" style="margin-top:10px"><a href="/en/pricing/">Pricing</a> &middot; <a href="/en/portfolio/">Portfolio</a> &middot; <a href="/en/industries/">Industries</a> &middot; <a href="/en/geo/">Cities</a> &middot; <a href="/en/local-services/">Local services</a> &middot; <a href="/en/blog/">Blog</a> &middot; <a href="/en/glossary/">Glossary</a> &middot; <a href="/en/comparisons/">Comparisons</a> &middot; <a href="/en/case-studies/">Case studies</a> &middot; <a href="/en/tools/">Tools</a></p>',
 "bg": '<p class="ft-links" style="margin-top:10px"><a href="/bg/ceni/">Цени</a> &middot; <a href="/bg/portfolio/">Портфолио</a> &middot; <a href="/bg/branshove/">Браншове</a> &middot; <a href="/bg/geo/">Градове</a> &middot; <a href="/bg/uslugi-lokalni/">Услуги по градове</a> &middot; <a href="/bg/blog/">Блог</a> &middot; <a href="/bg/rechnik/">Речник</a> &middot; <a href="/bg/sravneniya/">Сравнения</a> &middot; <a href="/bg/keys-studii/">Кейс стъдита</a> &middot; <a href="/bg/instrumenti/">Инструменти</a></p>',
}
