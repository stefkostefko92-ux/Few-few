...
<tr><td>Costo iniziale</td><td>da €1.575 + IVA</td><td>da €2.000</td></tr>
...
<tr><td>Upfront cost</td><td>from €1,575 + VAT</td><td>from €2,000</td></tr>
...
<p>Start from the goal, not the technology. If you need a site that's easy to update and quick to launch, our <a href="/en/services/web-development/">web development service</a> starts at €1,575 + VAT on optimized WordPress. If you're chasing extreme performance and a modern frontend, we'll weigh a headless architecture together. Either way, technical <a href="/en/services/seo/">SEO</a> is what shapes the final result.</p>""",
  faqs=[
   ...
   ("Does headless cost more than classic WordPress?", "Yes. A headless project starts around €2,000 versus €1,575 + VAT for traditional WordPress, because it needs a custom frontend and two systems to maintain. It only pays off when the performance or multi-channel benefits genuinely justify the investment."),
...
<tr><td>Начален разход</td><td>от €1890 с ДДС</td><td>от €2000</td></tr>
...
<p>Тръгнете от целта, не от технологията. Ако ви трябва сайт, който се обновява лесно и се пуска бързо, нашата <a href="/bg/uslugi/web-razrabotka/">услуга за изработка на сайтове</a> започва от €1890 с ДДС на оптимизиран WordPress. Ако търсите максимална производителност и модерен frontend, ще преценим headless архитектурата заедно. И в двата случая техническото <a href="/bg/uslugi/seo/">SEO</a> определя крайния резултат.</p>""",
  faqs=[
   ...
   ("Headless по-скъп ли е от класическия WordPress?", "Да. Headless проект започва от около €2000 срещу €1890 с ДДС за традиционен WordPress, защото изисква персонализиран frontend и две системи за поддръжка. Струва си само когато ползите от производителност или многоканалност реално оправдават инвестицията."),
...
<tr><td>Costo iniziale</td><td>da €1.825 + IVA + canone</td><td>da €5.000</td></tr>
...
<tr><td>Upfront cost</td><td>from €1,825 + VAT + fee</td><td>from €5,000</td></tr>
...
<tr><td>Начален разход</td><td>от €2190 с ДДС + такса</td><td>от €5000</td></tr>
...
<h2>Как да изберете</h2>
<p>Запитайте се колко сложен е моделът ви на продажби, не само колко продукта имате. За повечето магазини нашата <a href="/bg/uslugi/ecommerce/">услуга за онлайн магазини</a> започва от €2190 с ДДС и ви пуска онлайн бързо. Ако имате B2B логика, интеграции с <a href="/bg/uslugi/erp/">ERP</a> или няколко склада, ще преценим enterprise или решение по поръчка заедно. Пишете ни и ще ви кажем честно кое ви подхожда.</p>""",
  faqs=[
...
<p>Parti dalla domanda giusta: il tuo sito &egrave; soprattutto <em>contenuto</em> o soprattutto <em>interazione</em>? Se &egrave; contenuto, il nostro <a href="/servizi/sviluppo-siti-web/">servizio di sviluppo siti web</a> su WordPress ottimizzato parte da €1.575 + IVA. Se &egrave; interazione, costruiamo un frontend React/Next.js su misura. In entrambi i casi curiamo la <a href="/servizi/seo/">SEO tecnica</a>, perch&eacute; anche il sito più veloce serve a poco se Google non lo trova.</p>""",
  faqs=[
   ("React o WordPress: cosa è meglio per la SEO?", "Entrambi possono posizionarsi bene. WordPress ha plugin SEO maturi e gestione contenuti immediata; React con Next.js offre prestazioni eccellenti ma richiede rendering lato server per essere indicizzato bene. La SEO dipende dall'implementazione, non dalla tecnologia in se."),
...
<p>Start from the right question: is your site mostly <em>content</em> or mostly <em>interaction</em>? If it's content, our <a href="/en/services/web-development/">web development service</a> on optimized WordPress starts at €1,575 + VAT. If it's interaction, we build a custom React/Next.js frontend. Either way we handle technical <a href="/en/services/seo/">SEO</a>, because even the fastest site is useless if Google can't find it.</p>""",
  faqs=[
   ...
   ("Does React cost more than WordPress?", "Usually yes. A custom React site starts around €2,000 versus €1,575 + VAT for WordPress, because the frontend is built from scratch. It pays off when interactivity or performance justify it."),
...
<h2>Как да изберете</h2>
<p>Тръгнете от правилния въпрос: сайтът ви е предимно <em>съдържание</em> или предимно <em>интеракция</em>? Ако е съдържание, нашата <a href="/bg/uslugi/web-razrabotka/">услуга за изработка на сайтове</a> на оптимизиран WordPress започва от €1890 с ДДС. Ако е интеракция, изграждаме персонализиран React/Next.js frontend. И в двата случая се грижим за техническото <a href="/bg/uslugi/seo/">SEO</a>, защото и най-бързият сайт е безполезен, ако Google не го намира.</p>""",
  faqs=[
   ...
   ("React по-скъп ли е от WordPress?", "Обикновено да. Персонализиран React сайт започва от около €2000 срещу €1890 с ДДС за WordPress, защото frontend-ът се изгражда от нулата. Струва си, когато интерактивността или производителността го оправдават."),
...
<tr><td>Prezzo</td><td>da €1.575 + IVA</td><td>da €1.575 + IVA</td></tr>
...
<tr><td>Price</td><td>from €1,575 + VAT</td><td>from €1,575 + VAT</td></tr>
...
<h2>How to choose</h2>
<p>Ask where your traffic comes from. If you pay for ads and want to convert, start with a landing. If you want to grow organically, build the site and pair it with <a href="/en/services/seo/">SEO</a>. We build both: a landing starts at €1,575 + VAT, a brochure site at €1,575 + VAT. <a href="/en/contact/">Tell us the goal</a> and we'll say where to start.</p>""",
  faqs=[
   ...
   ("Does a landing page cost less than a brochure site?", "Yes. A landing page starts at €658 + VAT versus €1,575 + VAT for a brochure site, because it's a single page. But it covers a narrower goal and doesn't replace a full site."),
...
<tr><td>Цена</td><td>от €1890 с ДДС</td><td>от €1890 с ДДС</td></tr>
...
<h2>Как да изберете</h2>
<p>Запитайте се откъде идва трафикът. Ако плащате реклама и искате конверсии, започнете с landing. Ако искате органичен растеж, изградете сайта и добавете <a href="/bg/uslugi/seo/">SEO</a>. Правим и двете: landing започва от €1890 с ДДС, визитен сайт от €1890 с ДДС. <a href="/bg/kontakti/">Разкажете ни целта</a> и ще ви кажем откъде да започнете.</p>""",
  faqs=[
   ...
   ("Landing page по-евтина ли е от визитен сайт?", "Да. Landing page започва от €790 с ДДС срещу €1890 с ДДС за визитен сайт, защото е една страница. Но покрива по-тясна цел и не замества пълен сайт."),
...
<tr><td>Costo iniziale</td><td>da €1.575 + IVA</td><td>da €1.575 + IVA + canone</td></tr>
...
<tr><td>Upfront cost</td><td>from €1,575 + VAT</td><td>from €1,575 + VAT + fee</td></tr>
...
<tr><td>Начален разход</td><td>от €1890 с ДДС</td><td>от €1890 с ДДС + такса</td></tr>
...
<tr><td>Costo</td><td>Basso (pochi euro/mese)</td><td>da €13/mese + IVA</td></tr>
...
<tr><td>Cost</td><td>Low (a few euros/mo)</td><td>from €13/mo + VAT</td></tr>
...
<h2>How to choose</h2>
<p>Look at real traffic and needs. For a new site or a <a href="/en/services/web-development/">brochure site</a>, shared is enough. As you grow, our <a href="/en/services/hosting/">cloud hosting on VPS</a> starts at €13/month + VAT and gives you dedicated performance and security, with technical management included. Moving from shared to VPS can be done with no downtime when planned well: <a href="/en/contact/">get in touch</a> and we'll assess your case.</p>""",
  faqs=[
...
<tr><td>Разход</td><td>Нисък (няколко евро/мес)</td><td>от €15/мес с ДДС</td></tr>
...
<h2>Как да изберете</h2>
<p>Гледайте реалния трафик и нуждите. За нов сайт или <a href="/bg/uslugi/web-razrabotka/">визитен сайт</a> споделеният стига. Когато растете, нашият <a href="/bg/uslugi/hosting/">облачен хостинг на VPS</a> започва от €15/месец с ДДС и ви дава отделена производителност и сигурност, с включено техническо управление. Преминаването от споделен към VPS може да стане без прекъсване, ако е планирано добре: <a href="/bg/kontakti/">пишете ни</a> и ще преценим вашия случай.</p>""",
  faqs=[
