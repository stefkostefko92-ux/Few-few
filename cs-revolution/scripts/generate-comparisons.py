...
L = {
 ...
 "en": dict(
   prefix="/en", og="og/og-confronti-en.png", locale="en_US", hub="/en/comparisons/",
 ...
 "bg": dict(
   prefix="/bg", og="og/og-confronti-bg.png", locale="bg_BG", hub="/bg/sravneniya/",
...
<tr><td>Costo iniziale</td><td>da €1.890</td><td>da €2.000</td></tr>
...
<p>Parti dall'obiettivo, non dalla tecnologia. Se ti serve un sito che si aggiorna facilmente e si lancia in fretta, il nostro <a href="/servizi/sviluppo-siti-web/">servizio di sviluppo siti web</a> parte da €1.890 su WordPress ottimizzato. Se punti a prestazioni estreme e a un frontend moderno, valutiamo insieme un'architettura headless. In entrambi i casi la <a href="/servizi/seo/">SEO</a> tecnica fa la differenza sul risultato finale.</p>""",
  faqs=[
   ...
   ("Headless costa piu di WordPress classico?", "Si. Un progetto headless parte da circa €2.000 contro gli €1.890 di un WordPress tradizionale, perche richiede un frontend su misura e due sistemi da mantenere. Conviene solo quando i vantaggi di prestazioni o multicanale ripagano davvero l'investimento."),
...
<tr><td>Upfront cost</td><td>from €1,890</td><td>from €2,000</td></tr>
...
<p>Start from the goal, not the technology. If you need a site that's easy to update and quick to launch, our <a href="/en/services/web-development/">web development service</a> starts at €1,890 on optimized WordPress. If you're chasing extreme performance and a modern frontend, we'll weigh a headless architecture together. Either way, technical <a href="/en/services/seo/">SEO</a> is what shapes the final result.</p>""",
  faqs=[
   ...
   ("Does headless cost more than classic WordPress?", "Yes. A headless project starts around €2,000 versus €1,890 for traditional WordPress, because it needs a custom frontend and two systems to maintain. It only pays off when the performance or multi-channel benefits genuinely justify the investment."),
...
<tr><td>Начален разход</td><td>от €1890</td><td>от €2000</td></tr>
...
<p>Тръгнете от целта, не от технологията. Ако ви трябва сайт, който се обновява лесно и се пуска бързо, нашата <a href="/bg/uslugi/web-razrabotka/">услуга за изработка на сайтове</a> започва от €1890 на оптимизиран WordPress. Ако търсите максимална производителност и модерен frontend, ще преценим headless архитектурата заедно. И в двата случая техническото <a href="/bg/uslugi/seo/">SEO</a> определя крайния резултат.</p>""",
  faqs=[
   ...
   ("Headless по-скъп ли е от класическия WordPress?", "Да. Headless проект започва от около €2000 срещу €1890 за традиционен WordPress, защото изисква персонализиран frontend и две системи за поддръжка. Струва си само когато ползите от производителност или многоканалност реално оправдават инвестицията."),
...
<tr><td>Costo iniziale</td><td>da €2.190 + canone</td><td>da €5.000</td></tr>
<tr><td>Canone piattaforma</td><td>da ~€30/mese</td><td>Open Source gratis / Adobe a listino enterprise</td></tr>
...
<tr><td>Upfront cost</td><td>from €2,190 + fee</td><td>from €5,000</td></tr>
<tr><td>Platform fee</td><td>from ~€30/mo</td><td>Open Source free / Adobe enterprise pricing</td></tr>
...
<tr><td>Начален разход</td><td>от €2190 + такса</td><td>от €5000</td></tr>
<tr><td>Такса за платформа</td><td>от ~€30/мес</td><td>Open Source безплатно / Adobe enterprise цени</td></tr>
...
<h2>Как да изберете</h2>
<p>Запитайте се колко сложен е моделът ви на продажби, не само колко продукта имате. За повечето магазини нашата <a href="/bg/uslugi/ecommerce/">услуга за онлайн магазини</a> започва от €2190 и ви пуска онлайн бързо. Ако имате B2B логика, интеграции с <a href="/bg/uslugi/erp/">ERP</a> или няколко склада, ще преценим enterprise или решение по поръчка заедно. Пишете ни и ще ви кажем честно кое ви подхожда.</p>""",
  faqs=[
...
<h2>Come scegliere</h2>
<p>Parti dalla domanda giusta: il tuo sito &egrave; soprattutto <em>contenuto</em> o soprattutto <em>interazione</em>? Se &egrave; contenuto, il nostro <a href="/servizi/sviluppo-siti-web/">servizio di sviluppo siti web</a> su WordPress ottimizzato parte da €1.890. Se &egrave; interazione, costruiamo un frontend React/Next.js su misura. In entrambi i casi curiamo la <a href="/servizi/seo/">SEO tecnica</a>, perch&eacute; anche il sito piu veloce serve a poco se Google non lo trova.</p>""",
  faqs=[
   ...
   ("React costa piu di WordPress?", "Si, di solito. Un sito React su misura parte da circa €2.000 contro gli €1.890 di un WordPress, perche il frontend viene costruito da zero. Conviene quando l'interattivita o le prestazioni lo giustificano."),
...
<p>Start from the right question: is your site mostly <em>content</em> or mostly <em>interaction</em>? If it's content, our <a href="/en/services/web-development/">web development service</a> on optimized WordPress starts at €1,890. If it's interaction, we build a custom React/Next.js frontend. Either way we handle technical <a href="/en/services/seo/">SEO</a>, because even the fastest site is useless if Google can't find it.</p>""",
  faqs=[
   ...
   ("Does React cost more than WordPress?", "Usually yes. A custom React site starts around €2,000 versus €1,890 for WordPress, because the frontend is built from scratch. It pays off when interactivity or performance justify it."),
...
<h2>Как да изберете</h2>
<p>Тръгнете от правилния въпрос: сайтът ви е предимно <em>съдържание</em> или предимно <em>интеракция</em>? Ако е съдържание, нашата <a href="/bg/uslugi/web-razrabotka/">услуга за изработка на сайтове</a> на оптимизиран WordPress започва от €1890. Ако е интеракция, изграждаме персонализиран React/Next.js frontend. И в двата случая се грижим за техническото <a href="/bg/uslugi/seo/">SEO</a>, защото и най-бързият сайт е безполезен, ако Google не го намира.</p>""",
  faqs=[
   ...
   ("React по-скъп ли е от WordPress?", "Обикновено да. Персонализиран React сайт започва от около €2000 срещу €1890 за WordPress, защото frontend-ът се изгражда от нулата. Струва си, когато интерактивността или производителността го оправдават."),
...
<tr><td>Prezzo</td><td>da €1.890</td><td>da €1.890</td></tr>
...
<h2>Come scegliere</h2>
<p>Chiediti da dove arriva il traffico. Se paghi la pubblicit&agrave; e vuoi convertire, parti da una landing. Se vuoi crescere in modo organico, costruisci il sito e affianca la <a href="/servizi/seo/">SEO</a>. Realizziamo entrambi: una landing parte da €1.890, un sito vetrina da €1.890. <a href="/contatti/">Raccontaci l'obiettivo</a> e ti diciamo da cosa conviene partire.</p>""",
  faqs=[
   ...
   ("Costa meno una landing page o un sito vetrina?", "La landing page costa meno: parte da €790 contro gli €1.890 di un sito vetrina, perche e una sola pagina. Ma copre un obiettivo piu ristretto e non sostituisce un sito completo."),
...
<tr><td>Price</td><td>from €1,890</td><td>from €1,890</td></tr>
...
<h2>How to choose</h2>
<p>Ask where your traffic comes from. If you pay for ads and want to convert, start with a landing. If you want to grow organically, build the site and pair it with <a href="/en/services/seo/">SEO</a>. We build both: a landing starts at €1,890, a brochure site at €1,890. <a href="/en/contact/">Tell us the goal</a> and we'll say where to start.</p>""",
  faqs=[
   ...
   ("Does a landing page cost less than a brochure site?", "Yes. A landing page starts at €790 versus €1,890 for a brochure site, because it's a single page. But it covers a narrower goal and doesn't replace a full site."),
...
<tr><td>Цена</td><td>от €1890</td><td>от €1890</td></tr>
...
<h2>Как да изберете</h2>
<p>Запитайте се откъде идва трафикът. Ако плащате реклама и искате конверсии, започнете с landing. Ако искате органичен растеж, изградете сайта и добавете <a href="/bg/uslugi/seo/">SEO</a>. Правим и двете: landing започва от €1890, визитен сайт от €1890. <a href="/bg/kontakti/">Разкажете ни целта</a> и ще ви кажем откъде да започнете.</p>""",
  faqs=[
   ...
   ("Landing page по-евтина ли е от визитен сайт?", "Да. Landing page започва от €790 срещу €1890 за визитен сайт, защото е една страница. Но покрива по-тясна цел и не замества пълен сайт."),
...
<tr><td>Costo</td><td>da €3.000 (un solo codice)</td><td>Fino al doppio (due codebase)</td></tr>
...
<tr><td>Cost</td><td>from €3,000 (one codebase)</td><td>Up to double (two codebases)</td></tr>
...
<tr><td>Разход</td><td>от €3000 (един код)</td><td>До двойно (две codebase)</td></tr>
...
<h2>Как да изберете</h2>
<p>Тръгнете от естеството на приложението. Ако е бизнес инструмент, e-commerce или услуга, Flutter почти винаги е по-ефективният избор: нашата <a href="/bg/uslugi/mobilni-prilozheniya/">услуга за разработка на приложения</a> започва от €3000. Ако приложението натоварва хардуера до предел, ще преценим нативно. Приложенията често разчитат на backend или <a href="/bg/uslugi/softuer/">софтуер по поръчка</a>: отчитаме го още в офертата.</p>""",
  faqs=[
   ("Flutter по-евтин ли е от нативната разработка?", "Обикновено да. С Flutter пишете един код за iOS и Android вместо два, така че разходите и времето намаляват рязко, често почти наполовина. Затова cross-platform приложение започва от €3000."),
...
<tr><td>Costo iniziale</td><td>da €1.890</td><td>da €1.890 + canone</td></tr>
<tr><td>Canone piattaforma</td><td>Nessuno (solo hosting)</td><td>Da ~€14-39/mese per sito</td></tr>
...
<h2>Come scegliere</h2>
<p>Chiediti quanto conta la libert&agrave; a lungo termine rispetto alla comodit&agrave; immediata. Se vuoi un sito tuo, estendibile e senza canoni crescenti, il nostro <a href="/servizi/sviluppo-siti-web/">servizio di sviluppo siti web</a> su WordPress parte da €1.890. Se punti su un design d'impatto e non ti pesa l'abbonamento, Webflow &egrave; valido. In entrambi i casi la <a href="/servizi/seo/">SEO</a> tecnica decide quanto ti trova Google.</p>""",
  faqs=[
...
<tr><td>Upfront cost</td><td>from €1,890</td><td>from €1,890 + fee</td></tr>
<tr><td>Platform fee</td><td>None (hosting only)</td><td>From ~€14-39/mo per site</td></tr>
...
<p>Ask how much long-term freedom matters versus immediate convenience. If you want a site that's yours, extensible and free of growing fees, our <a href="/en/services/web-development/">web development service</a> on WordPress starts at €1,890. If you're after striking design and don't mind the subscription, Webflow is solid. Either way, technical <a href="/en/services/seo/">SEO</a> decides how well Google finds you.</p>""",
  faqs=[
   ...
   ("Does Webflow have a mandatory fee?", "Yes. Webflow requires a monthly subscription for every published site (roughly €14 to €39 a month depending on the plan). WordPress has no platform fee: you pay only for hosting."),
...
<tr><td>Начален разход</td><td>от €1890</td><td>от €1890 + такса</td></tr>
<tr><td>Такса за платформа</td><td>Няма (само хостинг)</td><td>От ~€14-39/мес на сайт</td></tr>
...
<p>Запитайте се колко тежи дългосрочната свобода спрямо моментното удобство. Ако искате сайт, който е ваш, разширяем и без растящи такси, нашата <a href="/bg/uslugi/web-razrabotka/">услуга за изработка на сайтове</a> на WordPress започва от €1890. Ако търсите впечатляващ дизайн и абонаментът не ви пречи, Webflow е добър. И в двата случая техническото <a href="/bg/uslugi/seo/">SEO</a> решава колко добре ви намира Google.</p>""",
  faqs=[
   ...
   ("Webflow има ли задължителна такса?", "Да. Webflow изисква месечен абонамент за всеки публикуван сайт (ориентировъчно от €14 до €39 на месец според плана). WordPress няма такса за платформа: плащате само хостинг."),
...
<tr><td>Costo iniziale</td><td>Basso (canone mensile)</td><td>da €2.000</td></tr>
...
<p>Un <a href="/servizi/sviluppo-software/">software su misura</a> viene costruito sui tuoi processi reali: fa esattamente ci&ograve; che ti serve, si integra con gli strumenti che gi&agrave; usi e i dati restano tuoi. L'investimento iniziale &egrave; pi&ugrave; alto (da €2.000, e da €5.000 per un <a href="/servizi/erp/">ERP</a> completo), ma non paghi un canone crescente per utente e il valore resta nel tempo. &Egrave; la scelta giusta quando il tuo modo di lavorare &egrave; un vantaggio competitivo che nessun software pronto rispecchia.</p>
<h2>Come scegliere</h2>
...
<tr><td>Upfront cost</td><td>Low (monthly fee)</td><td>from €2,000</td></tr>
...
<p>A piece of <a href="/en/services/software-development/">custom software</a> is built around your real processes: it does exactly what you need, integrates with the tools you already use and keeps your data yours. The upfront investment is higher (from €2,000, and from €5,000 for a full <a href="/en/services/erp/">ERP</a>), but you pay no growing per-user fee and the value lasts. It's the right choice when the way you work is a competitive edge no off-the-shelf tool reflects.</p>
<h2>How to choose</h2>
<p>Do the math over the medium term, not just the first month. Add up the SaaS fee for the number of users you'll have in two or three years and compare it with a custom project paid once. If your processes are standard and small, SaaS wins. If they're specific or you scale fast, custom pays off. <a href="/en/contact/">Tell us how you work</a> and we'll run the honest numbers together.</p>""",
  faqs=[
   ...
   ("Does custom software always cost more?", "Upfront yes: it starts at €2,000 versus a modest SaaS fee. But over the medium term custom has no growing per-user fees, so it often costs less in total for companies that scale or have many users."),
...
<tr><td>Начален разход</td><td>Нисък (месечна такса)</td><td>от €2000</td></tr>
...
<p>Направете сметката в средносрочен план, не само за първия месец. Съберете SaaS таксата за броя потребители, които ще имате след две-три години, и я сравнете с проект по поръчка, платен веднъж. Ако процесите ви са стандартни и малки, SaaS печели. Ако са специфични или растете бързо, по поръчка се изплаща. <a href="/bg/kontakti/">Разкажете ни как работите</a> и ще направим честната сметка заедно.</p>""",
  faqs=[
   ...
   ("Софтуерът по поръчка винаги ли струва повече?", "В началото да: започва от €2000 срещу скромната SaaS такса. Но в средносрочен план по поръчка няма растящи такси на потребител, така че често струва по-малко общо за фирми, които растат или имат много потребители."),
...
<tr><td>Costo</td><td>Basso (pochi euro/mese)</td><td>da €15/mese</td></tr>
...
<tr><td>Cost</td><td>Low (a few euros/mo)</td><td>from €15/mo</td></tr>
...
<h2>How to choose</h2>
<p>Look at real traffic and needs. For a new site or a <a href="/en/services/web-development/">brochure site</a>, shared is enough. As you grow, our <a href="/en/services/hosting/">cloud hosting on VPS</a> starts at €15/month and gives you dedicated performance and security, with technical management included. Moving from shared to VPS can be done with no downtime when planned well: <a href="/en/contact/">get in touch</a> and we'll assess your case.</p>""",
  faqs=[
...
<tr><td>Разход</td><td>Нисък (няколко евро/мес)</td><td>от €15/мес</td></tr>
...
<h2>Как да изберете</h2>
<p>Гледайте реалния трафик и нуждите. За нов сайт или <a href="/bg/uslugi/web-razrabotka/">визитен сайт</a> споделеният стига. Когато растете, нашият <a href="/bg/uslugi/hosting/">облачен хостинг на VPS</a> започва от €15/месец и ви дава отделена производителност и сигурност, с включено техническо управление. Преминаването от споделен към VPS може да стане без прекъсване, ако е планирано добре: <a href="/bg/kontakti/">пишете ни</a> и ще преценим вашия случай.</p>""",
  faqs=[
