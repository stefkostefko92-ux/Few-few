...
L = {
 "it": dict(
   ...
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">HOME</a><a href="/chi-siamo/">CHI SIAMO</a><a href="/servizi/sviluppo-siti-web/">SERVIZI</a><a href="/settori/">SETTORI</a><a href="/prezzi/">PREZZI</a><a href="/contatti/">CONTATTI</a></div></nav>',
 ...
 "en": dict(
   ...
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">HOME</a><a href="/en/about/">ABOUT</a><a href="/en/services/web-development/">SERVICES</a><a href="/en/industries/">INDUSTRIES</a><a href="/en/pricing/">PRICING</a><a href="/en/contact/">CONTACT</a></div></nav>',
 ...
 "bg": dict(
   ...
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">ГЛАВНА</a><a href="/bg/za-nas/">ЗА НАС</a><a href="/bg/uslugi/web-razrabotka/">УСЛУГИ</a><a href="/bg/branshove/">БРАНШОВЕ</a><a href="/bg/ceni/">ЦЕНИ</a><a href="/bg/kontakti/">КОНТАКТИ</a></div></nav>',
...
dict(slug="ristoranti", related=["hotel-turismo", "ecommerce-alimentari", "artigiani-officine"],
 ...
 it=dict(
  desc="Sito web, menu digitale, prenotazioni e ordini online per ristoranti, pizzerie e trattorie. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>La base &egrave; un sito vetrina che si apre in meno di due secondi anche sotto rete mobile, con foto dei piatti, orari, indirizzo con mappa e un menu leggibile senza PDF da scaricare. Il menu digitale ti fa risparmiare le ristampe e ti permette di cambiare piatti e prezzi in autonomia. Il nostro <a href="/servizi/sviluppo-siti-web/">sviluppo siti web</a> per la ristorazione parte da <strong>€1.575 + IVA</strong> e include galleria, menu e modulo prenotazioni.</p>
<h2>Prenotazioni e ordini online</h2>
<p>Un modulo di prenotazione collegato al calendario elimina le telefonate perse nelle ore di punta e riduce i no-show con promemoria automatici. Se fai asporto o delivery, un sistema di ordini online tuo &mdash; senza le commissioni del 25-30% delle piattaforme &mdash; ti fa tenere il margine: un piccolo <a href="/servizi/ecommerce/">e-commerce</a> per il food parte da <strong>€1.825 + IVA</strong>. Per i locali pi&ugrave; strutturati sviluppiamo anche <a href="/servizi/app-mobile/">app mobile</a> con fidelity e ordini ricorrenti, da <strong>€3.000</strong>.</p>
<h2>Gestione della sala e del magazzino</h2>
<p>Quando cresci, il vero problema non &egrave; il sito ma la gestione: coperti, food cost, magazzino e fornitori. Un <a href="/servizi/erp/">gestionale su misura</a> (da <strong>€5.000</strong>) collega prenotazioni, consumi e acquisti, cos&igrave; sai quali piatti rendono davvero e quando riordinare. &Egrave; la differenza tra tirare a indovinare e decidere sui numeri.</p>
<h2>Farsi trovare su Google e Maps</h2>
<p>La maggior parte dei clienti arriva dalla ricerca locale. Ottimizziamo la scheda Google Business, i dati strutturati del menu e le recensioni, cos&igrave; il tuo ristorante compare quando qualcuno cerca dove mangiare in zona. La nostra <a href="/servizi/seo/">SEO locale</a> parte da €242/mese + IVA e si ripaga con i coperti in pi&ugrave;. Vale sia per un ristorante gourmet sia per una pizzeria di quartiere.</p>""",
  faqs=[
   ("Quanto costa un sito web per un ristorante?", "Un sito vetrina professionale con menu digitale, galleria fotografica e modulo prenotazioni parte da €1.575 + IVA. Aggiungendo ordini online per asporto e delivery si parte da €1.825 + IVA. Preventivo gratuito entro 24 ore."),
   ...
   ("Come faccio a comparire quando qualcuno cerca un ristorante in zona?", "Con la SEO locale: scheda Google Business ottimizzata, dati strutturati, foto e gestione delle recensioni. È il canale che porta più clienti a un ristorante e parte da €242/mese + IVA."),
  ]),
 en=dict(
  desc="Website, digital menu, reservations and online ordering for restaurants, pizzerias and trattorias. From €658 + VAT, free quote within 24 hours.",
...
<p>Most guests arrive from local search. We optimize your Google Business profile, menu structured data and reviews, so your restaurant shows up when someone looks for where to eat nearby. Our <a href="/en/services/seo/">local SEO</a> starts at €242/month + VAT and pays for itself in extra covers. It works for a fine-dining room and a neighborhood pizzeria alike.</p>""",
  faqs=[
   ...
   ("How do I show up when someone searches for a restaurant nearby?", "With local SEO: an optimized Google Business profile, structured data, photos and review management. It's the channel that brings a restaurant the most customers, and it starts at €242/month + VAT."),
  ]),
 bg=dict(
  desc="Сайт, дигитално меню, резервации и онлайн поръчки за ресторанти, пицарии и заведения. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Повечето клиенти идват от локално търсене. Оптимизираме Google Business профила, структурираните данни на менюто и отзивите, така че ресторантът ви да излиза, когато някой търси къде да яде наблизо. Нашето <a href="/bg/uslugi/seo/">локално SEO</a> започва от €290/месец с ДДС и се изплаща с повече заети маси. Важи както за изискан ресторант, така и за квартална пицария.</p>""",
  faqs=[
   ...
   ("Как да излизам, когато някой търси ресторант наблизо?", "С локално SEO: оптимизиран Google Business профил, структурирани данни, снимки и управление на отзивите. Това е каналът, който носи най-много клиенти на ресторант, и започва от €290/месец с ДДС."),
  ])),
...
dict(slug="moda-abbigliamento", related=["ecommerce-alimentari", "artigiani-officine", "servizi-professionali"],
 ...
 it=dict(
  desc="E-commerce, lookbook e gestione taglie/colori per brand di moda, boutique e abbigliamento. Da €1.825 + IVA, preventivo gratuito in 24 ore.",
...
<p>Il cuore &egrave; un <a href="/servizi/ecommerce/">e-commerce</a> (da <strong>€1.825 + IVA</strong>) costruito per la moda: matrice taglie/colori, gestione delle scorte per variante, zoom sulle immagini, guida alle taglie per ridurre i resi e un carrello che si apre in un lampo. Integriamo pagamenti (Stripe, PayPal, carte), spedizioni e resi automatizzati, perch&eacute; nel fashion la logistica dei resi &egrave; parte della vendita.</p>
<h2>Lookbook e brand identity</h2>
<p>Prima dell'acquisto c'&egrave; il desiderio. Un <a href="/servizi/sviluppo-siti-web/">sito</a> (da <strong>€1.575 + IVA</strong>) con lookbook, storytelling e collezioni stagionali costruisce il brand e alimenta l'e-commerce. Cura tipografica, immagini a tutta pagina e caricamento rapido raccontano il posizionamento del marchio meglio di qualsiasi descrizione.</p>
<h2>Magazzino, taglie e multicanale</h2>
<p>Chi vende moda vive di stagioni, saldi e canali multipli (sito, negozio fisico, marketplace). Un <a href="/servizi/erp/">gestionale</a> (da <strong>€5.000</strong>) sincronizza le giacenze tra tutti i canali cos&igrave; da non vendere un capo gi&agrave; esaurito, e ti dice quali taglie e colori rendono. Per i brand con clientela fedele, un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) con drop e notifiche spinge i lanci.</p>
<h2>Farsi trovare e vendere ai motori AI</h2>
<p>La ricerca di moda passa da Google Immagini, Shopping e sempre pi&ugrave; dagli assistenti AI. Ottimizziamo schede prodotto, dati strutturati e contenuti con la nostra <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA), cos&igrave; le tue collezioni compaiono quando qualcuno cerca quel capo, quel colore, quello stile.</p>""",
  faqs=[
   ("Quanto costa un e-commerce per un brand di moda?", "Un e-commerce professionale con gestione taglie, colori e varianti parte da €1.825 + IVA. Il prezzo cresce con il numero di prodotti, le integrazioni logistiche e il livello di personalizzazione del design. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="E-commerce, lookbooks and size/color management for fashion brands, boutiques and clothing. From €1,825 + VAT, free quote within 24 hours.",
...
<p>The core is an <a href="/en/services/ecommerce/">e-commerce</a> (from <strong>€1,825 + VAT</strong>) built for fashion: a size/color matrix, per-variant stock, image zoom, a size guide to cut returns and a cart that opens instantly. We integrate payments (Stripe, PayPal, cards), shipping and automated returns, because in fashion the returns flow is part of the sale.</p>
<h2>Lookbook and brand identity</h2>
<p>Before the purchase comes desire. A <a href="/en/services/web-development/">site</a> (from <strong>€1,575 + VAT</strong>) with a lookbook, storytelling and seasonal collections builds the brand and feeds the store. Careful typography, full-bleed imagery and fast loading convey a brand's positioning better than any description.</p>
<h2>Stock, sizes and multichannel</h2>
<p>Fashion runs on seasons, sales and multiple channels (site, physical shop, marketplaces). A <a href="/en/services/erp/">management system</a> (from <strong>€5,000</strong>) syncs stock across every channel so you never sell a sold-out item, and tells you which sizes and colors perform. For brands with loyal customers, an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) with drops and push notifications powers launches.</p>
<h2>Getting found and selling to AI engines</h2>
<p>Fashion search runs through Google Images, Shopping and increasingly AI assistants. We optimize product pages, structured data and content with our <a href="/en/services/seo/">SEO</a> (from €242/month + VAT), so your collections appear when someone searches for that piece, that color, that style.</p>""",
  faqs=[
   ("How much does a fashion e-commerce cost?", "A professional e-commerce with size, color and variant management starts at €1,825 + VAT. The price grows with the number of products, logistics integrations and how custom the design is. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Онлайн магазин, лукбук и управление на размери/цветове за модни брандове, бутици и облекло. От €2190 с ДДС, безплатна оферта до 24 часа.",
...
<p>Ядрото е <a href="/bg/uslugi/ecommerce/">онлайн магазин</a> (от <strong>€2190 с ДДС</strong>), направен за мода: матрица размер/цвят, наличност по вариант, увеличение на снимките, таблица с размери за по-малко връщания и количка, която се отваря мигновено. Интегрираме плащания (Stripe, PayPal, карти), доставки и автоматизирани връщания, защото в модата логистиката на връщанията е част от продажбата.</p>
<h2>Лукбук и идентичност на бранда</h2>
<p>Преди покупката идва желанието. <a href="/bg/uslugi/web-razrabotka/">Сайт</a> (от <strong>€1890 с ДДС</strong>) с лукбук, разказ за бранда и сезонни колекции изгражда марката и захранва магазина. Прецизна типография, изображения на цял екран и бързо зареждане предават позиционирането на бранда по-добре от всяко описание.</p>
<h2>Склад, размери и много канали</h2>
<p>Модата живее от сезони, разпродажби и много канали (сайт, физически магазин, маркетплейси). <a href="/bg/uslugi/erp/">Управленска система</a> (от <strong>€5000</strong>) синхронизира наличностите между всички канали, за да не продадете изчерпан артикул, и ви показва кои размери и цветове се движат. За брандове с лоялни клиенти <a href="/bg/uslugi/mobilni-prilozheniya/">приложение</a> (от <strong>€3000</strong>) с дропове и известия усилва пусканията.</p>
<h2>Да ви намират и да продавате на AI търсачки</h2>
<p>Търсенето на мода минава през Google Images, Shopping и все повече през AI асистенти. Оптимизираме продуктови страници, структурирани данни и съдържание с нашето <a href="/bg/uslugi/seo/">SEO</a> (от €290/месец с ДДС), така че колекциите ви да излизат, когато някой търси точно тази дреха, този цвят, този стил.</p>""",
  faqs=[
   ("Колко струва онлайн магазин за моден бранд?", "Професионален онлайн магазин с управление на размери, цветове и варианти започва от €2190 с ДДС. Цената расте с броя продукти, логистичните интеграции и степента на персонализация. Безплатна оферта до 24 часа."),
...
dict(slug="immobiliare", related=["servizi-professionali", "hotel-turismo", "avvocati"],
 ...
 it=dict(
  desc="Portale annunci, ricerca avanzata, gestione lead e CRM per agenzie immobiliari. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Costruiamo <a href="/servizi/sviluppo-siti-web/">portali immobiliari</a> (da <strong>€1.575 + IVA</strong>) con ricerca per zona, prezzo, tipologia e caratteristiche, mappa interattiva, gallerie foto ad alta risoluzione, planimetrie e tour virtuali. Ogni scheda ha dati strutturati per comparire meglio su Google, e un modulo di contatto rapido che trasforma il visitatore in richiesta di visita.</p>
<h2>Gestione lead e CRM</h2>
<p>Il valore vero &egrave; nella gestione delle richieste. Un <a href="/servizi/erp/">gestionale/CRM su misura</a> (da <strong>€5.000</strong>) raccoglie i lead da sito, portali esterni e telefono in un unico posto, li assegna agli agenti, traccia gli appuntamenti e ti dice quali immobili generano pi&ugrave; interesse. Con la sincronizzazione dei portali (Immobiliare.it, Idealista) pubblichi un annuncio una volta e appare ovunque.</p>
<h2>App per agenti e clienti</h2>
<p>Per le agenzie strutturate, un'<a href="/servizi/app-mobile/">app mobile</a> (da <strong>€3.000</strong>) permette agli agenti di caricare immobili e foto sul posto e ai clienti di ricevere notifiche appena esce una casa che corrisponde ai loro criteri: chi arriva primo, prenota la visita.</p>
<h2>SEO locale e visibilit&agrave;</h2>
<p>Le ricerche immobiliari sono locali per definizione: &laquo;case in vendita [quartiere]&raquo;. Con la <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA) ottimizziamo pagine di zona, dati strutturati degli immobili e la scheda Google, cos&igrave; la tua agenzia intercetta chi cerca proprio dove operi tu, prima dei grandi portali generalisti.</p>""",
  faqs=[
   ("Quanto costa un sito per un'agenzia immobiliare?", "Un portale con ricerca avanzata, schede immobile e mappa parte da €1.575 + IVA. Aggiungendo un CRM per gestire lead e agenti si passa a un progetto su misura da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Listing portal, advanced search, lead management and CRM for real estate agencies. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">real estate portals</a> (from <strong>€1,575 + VAT</strong>) with search by area, price, type and features, an interactive map, high-resolution galleries, floor plans and virtual tours. Every listing carries structured data to rank better on Google, plus a quick contact form that turns a visitor into a viewing request.</p>
<h2>Lead management and CRM</h2>
<p>The real value is in handling enquiries. A <a href="/en/services/erp/">custom CRM/management system</a> (from <strong>€5,000</strong>) gathers leads from your site, external portals and phone in one place, assigns them to agents, tracks appointments and tells you which properties draw the most interest. With portal sync (Rightmove, Idealista and similar) you publish a listing once and it appears everywhere.</p>
<h2>Apps for agents and clients</h2>
<p>For larger agencies, a <a href="/en/services/mobile-apps/">mobile app</a> (from <strong>€3,000</strong>) lets agents upload properties and photos on site, and lets clients get a notification the moment a home matching their criteria appears: whoever arrives first books the viewing.</p>
<h2>Local SEO and visibility</h2>
<p>Property searches are local by nature: &laquo;houses for sale [neighborhood]&raquo;. With <a href="/en/services/seo/">SEO</a> (from €242/month + VAT) we optimize area pages, property structured data and your Google profile, so your agency captures people searching exactly where you operate, ahead of the big generalist portals.</p>""",
  faqs=[
   ("How much does a real estate agency website cost?", "A portal with advanced search, property pages and a map starts at €1,575 + VAT. Adding a CRM to manage leads and agents moves it to a custom project from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Портал за обяви, разширено търсене, управление на запитвания и CRM за агенции за недвижими имоти. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изграждаме <a href="/bg/uslugi/web-razrabotka/">имотни портали</a> (от <strong>€1890 с ДДС</strong>) с търсене по район, цена, тип и характеристики, интерактивна карта, галерии с висока резолюция, разпределения и виртуални огледи. Всяка обява носи структурирани данни за по-добро класиране в Google и бърза форма за контакт, която превръща посетителя в заявка за оглед.</p>
...
<p>За по-големите агенции <a href="/bg/uslugi/mobilni-prilozheniya/">мобилно приложение</a> (от <strong>€3000</strong>) позволява на брокерите да качват имоти и снимки на място, а на клиентите — да получават известие в момента, в който излезе имот по техните критерии: който дойде пръв, запазва огледа.</p>
<h2>Локално SEO и видимост</h2>
<p>Търсенията за имоти са локални по природа: &laquo;имоти за продажба [квартал]&raquo;. С <a href="/bg/uslugi/seo/">SEO</a> (от €290/месец с ДДС) оптимизираме страници по райони, структурирани данни на имотите и Google профила, така че агенцията ви хваща търсещите точно там, където работите, преди големите общи портали.</p>""",
  faqs=[
   ("Колко струва сайт за агенция за недвижими имоти?", "Портал с разширено търсене, страници на имотите и карта започва от €1890 с ДДС. С добавен CRM за управление на запитвания и брокери се преминава към проект по поръчка от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="studi-medici", related=["avvocati", "servizi-professionali", "palestre-fitness"],
 ...
 it=dict(
  desc="Sito, prenotazione visite online, gestione agenda e conformità privacy per studi medici, dentisti e cliniche. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per studi medici</a> (da <strong>€1.575 + IVA</strong>) chiari e rassicuranti: chi sei, l'&eacute;quipe, le prestazioni, gli orari, come raggiungerti e le informazioni utili al paziente. Testi comprensibili, caricamento veloce e piena accessibilit&agrave;, con cookie e informative a norma GDPR gestite correttamente.</p>
<h2>Prenotazione visite online</h2>
<p>Il modulo di prenotazione online &egrave; ci&ograve; che i pazienti chiedono di pi&ugrave;: scelgono prestazione, medico e orario disponibile senza chiamare, e ricevono promemoria automatici che abbattono le mancate presentazioni. Si collega alla tua agenda reale per evitare sovrapposizioni. Per studi con pi&ugrave; medici e sedi, un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) semplifica appuntamenti e referti.</p>
<h2>Gestione agenda, pazienti e cartelle</h2>
<p>Dietro le quinte, un <a href="/servizi/erp/">gestionale su misura</a> (da <strong>€5.000</strong>) organizza agende multiple, anagrafica pazienti, storico visite, promemoria e fatturazione. Progettato con attenzione alla protezione dei dati sanitari, ti fa risparmiare ore di segreteria e riduce gli errori. Nulla di pi&ugrave; del necessario, tutto dove serve.</p>
<h2>Farsi trovare in zona</h2>
<p>Le ricerche mediche sono locali e urgenti: &laquo;dentista [citt&agrave;]&raquo;, &laquo;pediatra vicino a me&raquo;. Con la <a href="/servizi/seo/">SEO locale</a> (da €242/mese + IVA) ottimizziamo scheda Google, pagine per prestazione e recensioni, cos&igrave; il tuo studio compare nel momento in cui un paziente cerca proprio la tua specialit&agrave;.</p>""",
  faqs=[
   ("Quanto costa un sito per uno studio medico?", "Un sito professionale con presentazione, prestazioni e prenotazione online parte da €1.575 + IVA. Con gestione agenda, pazienti e fatturazione si passa a un gestionale su misura da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Website, online appointment booking, schedule management and privacy compliance for clinics, dentists and medical practices. From €658 + VAT, free quote within 24 hours.",
...
<p>Medical searches are local and urgent: &laquo;dentist [city]&raquo;, &laquo;pediatrician near me&raquo;. With <a href="/en/services/seo/">local SEO</a> (from €242/month + VAT) we optimize your Google profile, per-service pages and reviews, so your practice appears the moment a patient searches for exactly your specialty.</p>""",
 ...
 bg=dict(
  desc="Сайт, онлайн записване на часове, управление на график и съответствие с GDPR за лекарски кабинети, зъболекари и клиники. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Медицинските търсения са локални и спешни: &laquo;зъболекар [град]&raquo;, &laquo;педиатър близо до мен&raquo;. С <a href="/bg/uslugi/seo/">локално SEO</a> (от €290/месец с ДДС) оптимизираме Google профила, страници по услуга и отзивите, така че кабинетът ви да излиза точно когато пациент търси вашата специалност.</p>""",
  faqs=[
   ("Колко струва сайт за лекарски кабинет?", "Професионален сайт с представяне, услуги и онлайн записване започва от €1890 с ДДС. С управление на график, пациенти и фактуриране се преминава към система по поръчка от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="avvocati", related=["servizi-professionali", "studi-medici", "immobiliare"],
 ...
 it=dict(
  desc="Sito professionale, prenotazione consulenze e gestione pratiche per avvocati e studi legali. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per avvocati</a> (da <strong>€1.575 + IVA</strong>) sobri e professionali: aree di diritto trattate, profilo dei professionisti, casi e competenze, un blog giuridico che dimostra autorevolezza e un modulo di contatto riservato. Design pulito, testi chiari e piena conformit&agrave; alle norme deontologiche e alla privacy.</p>
...
<p>Il cuore operativo di uno studio &egrave; la gestione delle pratiche. Un <a href="/servizi/erp/">gestionale su misura</a> (da <strong>€5.000</strong>) organizza fascicoli, scadenze processuali, documenti, parcelle e comunicazioni con i clienti in un unico sistema sicuro. Le scadenze non si perdono, i documenti sono tracciati e la fatturazione &egrave; ordinata: meno rischio, pi&ugrave; tempo per il lavoro legale.</p>
<h2>Farsi trovare per la propria materia</h2>
<p>Chi cerca un avvocato usa termini precisi: &laquo;avvocato divorzista [citt&agrave;]&raquo;, &laquo;recupero crediti&raquo;. Con la <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA) creiamo pagine per area di diritto e ottimizziamo la scheda locale, cos&igrave; il tuo studio compare quando qualcuno cerca esattamente la tua specializzazione, con contenuti che dimostrano competenza.</p>""",
  faqs=[
   ("Quanto costa un sito per uno studio legale?", "Un sito professionale con aree di diritto, profili e modulo consulenza parte da €1.575 + IVA. Con un gestionale per pratiche, scadenze e parcelle si passa a un progetto su misura da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Professional website, consultation booking and case management for lawyers and law firms. From €658 + VAT, free quote within 24 hours.",
...
<p>The operational core of a firm is case management. A <a href="/en/services/erp/">custom management system</a> (from <strong>€5,000</strong>) organizes files, court deadlines, documents, fees and client communications in one secure system. Deadlines aren't missed, documents are tracked and billing is orderly: less risk, more time for legal work.</p>
<h2>Getting found for your practice area</h2>
<p>People searching for a lawyer use precise terms: &laquo;divorce lawyer [city]&raquo;, &laquo;debt recovery&raquo;. With <a href="/en/services/seo/">SEO</a> (from €242/month + VAT) we create practice-area pages and optimize your local profile, so your firm appears when someone searches for exactly your specialty, with content that proves expertise.</p>""",
  faqs=[
   ("How much does a law firm website cost?", "A professional site with practice areas, profiles and a consultation form starts at €1,575 + VAT. With a case-management system for files, deadlines and fees it becomes a custom project from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Професионален сайт, записване на консултации и управление на дела за адвокати и кантори. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Търсещите адвокат използват точни думи: &laquo;адвокат по бракоразводни дела [град]&raquo;, &laquo;събиране на вземания&raquo;. С <a href="/bg/uslugi/seo/">SEO</a> (от €290/месец с ДДС) създаваме страници по област на правото и оптимизираме локалния профил, така че кантората ви да излиза, когато някой търси точно вашата специализация, със съдържание, което доказва компетентност.</p>""",
  faqs=[
   ("Колко струва сайт за адвокатска кантора?", "Професионален сайт с области на правото, профили и форма за консултация започва от €1890 с ДДС. С управленска система за дела, срокове и хонорари се преминава към проект по поръчка от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="palestre-fitness", related=["studi-medici", "hotel-turismo", "servizi-professionali"],
 ...
 it=dict(
  desc="Sito, prenotazione corsi, gestione abbonamenti e app per palestre, centri fitness e personal trainer. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Costruiamo <a href="/servizi/sviluppo-siti-web/">siti per palestre</a> (da <strong>€1.575 + IVA</strong>) con orari dei corsi, listino trasparente, presentazione dei trainer, gallerie e una prova gratuita prenotabile subito. Un sito veloce e chiaro trasforma chi cerca &laquo;palestra vicino a me&raquo; in una prova, e la prova in un abbonamento.</p>
<h2>Prenotazione corsi e app per i soci</h2>
<p>Il cuore dell'esperienza &egrave; la prenotazione delle lezioni: posti limitati, lista d'attesa, disdette entro un orario. Un'<a href="/servizi/app-mobile/">app dedicata</a> (da <strong>€3.000</strong>) con prenotazione, scheda allenamento, notifiche e check-in aumenta la frequenza e la fidelizzazione: i soci che usano l'app rinnovano di pi&ugrave;. Chi vende integratori o merchandising pu&ograve; aggiungere un piccolo <a href="/servizi/ecommerce/">e-commerce</a> (da <strong>€1.825 + IVA</strong>).</p>
<h2>Gestione abbonamenti e incassi</h2>
<p>Dietro, un <a href="/servizi/erp/">gestionale</a> (da <strong>€5.000</strong>) tiene sotto controllo abbonamenti, scadenze, pagamenti ricorrenti, presenze e rinnovi. Ti avvisa quando un abbonamento sta per scadere e quando un socio smette di venire &mdash; il primo segnale dell'abbandono &mdash; cos&igrave; puoi intervenire prima di perderlo.</p>
<h2>Farsi trovare in zona</h2>
<p>Il fitness &egrave; iper-locale: si sceglie la palestra vicino a casa o al lavoro. Con la <a href="/servizi/seo/">SEO locale</a> (da €242/mese + IVA) ottimizziamo scheda Google, recensioni e pagine per servizio (sala pesi, corsi, personal training), cos&igrave; il tuo centro intercetta chi cerca proprio nella tua zona.</p>""",
  faqs=[
   ("Quanto costa un sito per una palestra?", "Un sito con orari corsi, listino e prenotazione prova parte da €1.575 + IVA. Con app per i soci si aggiunge da €3.000 e con gestione abbonamenti completa si arriva a un gestionale da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Website, class booking, membership management and apps for gyms, fitness centers and personal trainers. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">gym websites</a> (from <strong>€1,575 + VAT</strong>) with class schedules, transparent pricing, trainer profiles, galleries and a free trial bookable on the spot. A fast, clear site turns someone searching &laquo;gym near me&raquo; into a trial, and the trial into a membership.</p>
<h2>Class booking and a member app</h2>
<p>The heart of the experience is class booking: limited spots, waitlists, cancellations within a cutoff. A <a href="/en/services/mobile-apps/">dedicated app</a> (from <strong>€3,000</strong>) with booking, workout plans, notifications and check-in boosts attendance and loyalty: members who use the app renew more. If you sell supplements or merchandise, add a small <a href="/en/services/ecommerce/">e-commerce</a> (from <strong>€1,825 + VAT</strong>).</p>
<h2>Membership and revenue management</h2>
<p>Behind it, a <a href="/en/services/erp/">management system</a> (from <strong>€5,000</strong>) keeps memberships, expiries, recurring payments, attendance and renewals under control. It warns you when a membership is about to lapse and when a member stops showing up &mdash; the first sign of churn &mdash; so you can act before you lose them.</p>
<h2>Getting found locally</h2>
<p>Fitness is hyper-local: people choose the gym near home or work. With <a href="/en/services/seo/">local SEO</a> (from €242/month + VAT) we optimize your Google profile, reviews and per-service pages (weights room, classes, personal training), so your center captures people searching right in your area.</p>""",
  faqs=[
   ("How much does a gym website cost?", "A site with class schedules, pricing and trial booking starts at €1,575 + VAT. A member app adds from €3,000, and full membership management brings a system from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Сайт, записване за занятия, управление на абонаменти и приложение за фитнес зали, центрове и персонални треньори. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изграждаме <a href="/bg/uslugi/web-razrabotka/">сайтове за фитнес зали</a> (от <strong>€1890 с ДДС</strong>) с график на занятията, прозрачни цени, представяне на треньорите, галерии и безплатна пробна тренировка за записване веднага. Бърз и ясен сайт превръща търсещия &laquo;фитнес близо до мен&raquo; в пробна тренировка, а нея — в абонамент.</p>
<h2>Записване за занятия и приложение за членове</h2>
<p>Сърцето на изживяването е записването за тренировки: ограничени места, списък на чакащите, отказ до определен час. <a href="/bg/uslugi/mobilni-prilozheniya/">Специално приложение</a> (от <strong>€3000</strong>) със записване, тренировъчни програми, известия и check-in увеличава посещаемостта и лоялността: членовете, които ползват приложението, подновяват повече. Ако продавате добавки или мърчандайз, добавете малък <a href="/bg/uslugi/ecommerce/">онлайн магазин</a> (от <strong>€2190 с ДДС</strong>).</p>
<h2>Управление на абонаменти и приходи</h2>
<p>Зад всичко <a href="/bg/uslugi/erp/">управленска система</a> (от <strong>€5000</strong>) държи под контрол абонаментите, сроковете, повтарящите се плащания, посещенията и подновяванията. Предупреждава ви, когато абонамент изтича и когато член спре да идва — първият знак за отпадане — за да реагирате, преди да го загубите.</p>
<h2>Да ви намират в района</h2>
<p>Фитнесът е хипер-локален: избира се залата близо до дома или работата. С <a href="/bg/uslugi/seo/">локално SEO</a> (от €290/месец с ДДС) оптимизираме Google профила, отзивите и страници по услуга (зала за тежести, занятия, персонални тренировки), така че центърът ви да хваща търсещите точно във вашия район.</p>""",
  faqs=[
   ("Колко струва сайт за фитнес зала?", "Сайт с график на занятията, цени и записване за пробна тренировка започва от €1890 с ДДС. Приложение за членове добавя от €3000, а пълно управление на абонаменти носи система от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="hotel-turismo", related=["ristoranti", "immobiliare", "palestre-fitness"],
 ...
 it=dict(
  desc="Sito multilingue, motore di prenotazione diretta e gestione strutture per hotel, B&B e case vacanza. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per hotel</a> (da <strong>€1.575 + IVA</strong>) veloci, in pi&ugrave; lingue, con foto immersive delle camere, servizi, mappa e recensioni. Il caricamento rapido e le versioni tradotte sono decisivi: il turista internazionale prenota dove capisce tutto e dove il sito non lo fa aspettare.</p>
<h2>Motore di prenotazione diretta</h2>
<p>Il cuore &egrave; il booking engine: disponibilit&agrave; in tempo reale, tariffe, pagamento e conferma immediata, con integrazione al channel manager per evitare l'overbooking tra sito e OTA. Ogni prenotazione diretta ti fa risparmiare la commissione e ti d&agrave; i dati del cliente per fidelizzarlo. Per le catene o le strutture con clientela abituale, un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) aggiunge check-in e servizi in camera.</p>
<h2>Gestione struttura e tariffe</h2>
<p>Un <a href="/servizi/erp/">gestionale (PMS su misura)</a> (da <strong>€5.000</strong>) collega prenotazioni, camere, pulizie, tariffe stagionali e reportistica in un unico sistema. Sai sempre l'occupazione, il ricavo per camera e quali canali rendono, cos&igrave; puoi ottimizzare i prezzi invece di subirli.</p>
<h2>Farsi trovare dai turisti</h2>
<p>Il turismo passa da Google, Maps e sempre pi&ugrave; dagli assistenti AI. Con la <a href="/servizi/seo/">SEO multilingue</a> (da €242/mese + IVA) ottimizziamo scheda Google, dati strutturati (hotel, prezzi, recensioni) e contenuti nelle lingue dei tuoi ospiti, cos&igrave; la tua struttura compare nelle ricerche di viaggio prima e meglio.</p>""",
  faqs=[
   ("Quanto costa un sito per un hotel con prenotazioni dirette?", "Un sito multilingue con motore di prenotazione diretta parte da €1.575 + IVA per la parte web, con il booking engine integrato. Con un PMS gestionale completo si arriva a un progetto da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Multilingual website, direct booking engine and property management for hotels, B&Bs and holiday rentals. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">hotel websites</a> (from <strong>€1,575 + VAT</strong>) that are fast, multilingual, with immersive room photos, amenities, a map and reviews. Fast loading and translated versions are decisive: the international traveler books where they understand everything and where the site doesn't keep them waiting.</p>
<h2>Direct booking engine</h2>
<p>The core is the booking engine: real-time availability, rates, payment and instant confirmation, integrated with a channel manager to avoid overbooking between site and OTAs. Every direct booking saves the commission and gives you the guest's data to build loyalty. For chains or properties with regular guests, an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) adds check-in and in-room services.</p>
<h2>Property and rate management</h2>
<p>A <a href="/en/services/erp/">management system (custom PMS)</a> (from <strong>€5,000</strong>) links bookings, rooms, housekeeping, seasonal rates and reporting in one system. You always know occupancy, revenue per room and which channels perform, so you can optimize prices instead of accepting them.</p>
<h2>Getting found by travelers</h2>
<p>Tourism runs through Google, Maps and increasingly AI assistants. With <a href="/en/services/seo/">multilingual SEO</a> (from €242/month + VAT) we optimize your Google profile, structured data (hotel, prices, reviews) and content in your guests' languages, so your property appears in travel searches sooner and better.</p>""",
  faqs=[
   ("How much does a hotel website with direct bookings cost?", "A multilingual site with a direct booking engine starts at €1,575 + VAT for the web part, with the booking engine integrated. With a full property-management system it becomes a project from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Многоезичен сайт, система за директни резервации и управление на обекти за хотели, къщи за гости и ваканционни имоти. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изработваме <a href="/bg/uslugi/web-razrabotka/">сайтове за хотели</a> (от <strong>€1890 с ДДС</strong>), бързи, на няколко езика, с потапящи снимки на стаите, услуги, карта и отзиви. Бързото зареждане и преведените версии са решаващи: международният турист резервира там, където разбира всичко и където сайтът не го кара да чака.</p>
<h2>Система за директни резервации</h2>
<p>Ядрото е booking engine: наличност в реално време, тарифи, плащане и моментално потвърждение, с интеграция към channel manager, за да няма overbooking между сайта и OTA. Всяка директна резервация ви спестява комисионната и ви дава данните на госта за задържане. За вериги или обекти с редовни гости <a href="/bg/uslugi/mobilni-prilozheniya/">приложение</a> (от <strong>€3000</strong>) добавя check-in и услуги в стаята.</p>
<h2>Управление на обекта и тарифите</h2>
<p><a href="/bg/uslugi/erp/">Управленска система (PMS по поръчка)</a> (от <strong>€5000</strong>) свързва резервации, стаи, почистване, сезонни тарифи и отчети в една система. Винаги знаете заетостта, прихода на стая и кои канали носят печалба, за да оптимизирате цените, вместо да ги търпите.</p>
<h2>Да ви намират туристите</h2>
<p>Туризмът минава през Google, Maps и все повече през AI асистенти. С <a href="/bg/uslugi/seo/">многоезично SEO</a> (от €290/месец с ДДС) оптимизираме Google профила, структурираните данни (хотел, цени, отзиви) и съдържанието на езиците на гостите ви, така че обектът ви да излиза в туристическите търсения по-рано и по-добре.</p>""",
  faqs=[
   ("Колко струва сайт за хотел с директни резервации?", "Многоезичен сайт със система за директни резервации започва от €1890 с ДДС за уеб частта, с интегриран booking engine. С пълна PMS система се стига до проект от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="artigiani-officine", related=["produzione-industria", "servizi-professionali", "ristoranti"],
 ...
 it=dict(
  desc="Sito, richiesta preventivi, prenotazione interventi e gestione lavori per artigiani, officine e installatori. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per artigiani</a> (da <strong>€1.575 + IVA</strong>) essenziali ed efficaci: servizi, zona coperta, foto dei lavori, recensioni e pulsante &laquo;chiama ora&raquo; ben visibile su mobile. La maggior parte dei clienti arriva dal telefono: il sito deve trasformare la visita in una chiamata o in una richiesta di preventivo in pochi secondi.</p>
<h2>Preventivi e prenotazione interventi</h2>
<p>Un modulo di richiesta preventivo con foto del problema ti fa arrivare richieste gi&agrave; qualificate, e la prenotazione di un sopralluogo o intervento riduce le telefonate a vuoto. Per chi lavora in squadra, un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) permette di ricevere gli interventi, aggiornare lo stato e caricare foto direttamente dal cantiere.</p>
<h2>Gestione lavori, materiali e fatture</h2>
<p>Quando i lavori si accumulano, servono ordine e controllo dei margini. Un <a href="/servizi/erp/">gestionale su misura</a> (da <strong>€5.000</strong>) tiene insieme preventivi, ordini di lavoro, materiali, ore e fatturazione. Sai quanto rende ogni lavoro, quali materiali riordinare e quali preventivi sono in sospeso: meno carta, meno dimenticanze, pi&ugrave; incasso.</p>
<h2>Farsi trovare in zona</h2>
<p>Le ricerche sono locali e immediate: &laquo;idraulico [citt&agrave;]&raquo;, &laquo;gommista aperto adesso&raquo;. Con la <a href="/servizi/seo/">SEO locale</a> (da €242/mese + IVA) ottimizziamo scheda Google, recensioni e pagine per servizio e zona, cos&igrave; sei tu a comparire quando qualcuno cerca il tuo mestiere vicino a s&eacute;.</p>""",
  faqs=[
   ("Quanto costa un sito per un artigiano o un'officina?", "Un sito essenziale con servizi, zona coperta, foto lavori e pulsante di chiamata parte da €1.575 + IVA. Con gestione preventivi, lavori e fatture si passa a un gestionale da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Website, quote requests, job booking and work management for artisans, workshops and installers. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">websites for tradespeople</a> (from <strong>€1,575 + VAT</strong>) that are lean and effective: services, service area, job photos, reviews and a prominent &laquo;call now&raquo; button on mobile. Most customers arrive by phone: the site must turn the visit into a call or a quote request in seconds.</p>
<h2>Quotes and job booking</h2>
<p>A quote-request form with a photo of the problem brings you pre-qualified requests, and booking a site visit or job cuts wasted calls. For those working in a team, an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) lets you receive jobs, update status and upload photos straight from the site.</p>
<h2>Job, materials and invoice management</h2>
<p>When jobs pile up, you need order and margin control. A <a href="/en/services/erp/">custom management system</a> (from <strong>€5,000</strong>) holds quotes, work orders, materials, hours and invoicing together. You know how much each job makes, which materials to reorder and which quotes are pending: less paper, fewer things forgotten, more revenue collected.</p>
<h2>Getting found locally</h2>
<p>Searches are local and immediate: &laquo;plumber [city]&raquo;, &laquo;tire shop open now&raquo;. With <a href="/en/services/seo/">local SEO</a> (from €242/month + VAT) we optimize your Google profile, reviews and per-service and per-area pages, so you're the one appearing when someone searches for your trade nearby.</p>""",
  faqs=[
   ("How much does a website for an artisan or workshop cost?", "A lean site with services, service area, job photos and a call button starts at €1,575 + VAT. With quote, job and invoice management it becomes a system from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Сайт, запитвания за оферти, записване на посещения и управление на работата за занаятчии, сервизи и монтажници. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<h2>Да ви намират в района</h2>
<p>Търсенията са локални и незабавни: &laquo;водопроводчик [град]&raquo;, &laquo;автосервиз отворен сега&raquo;. С <a href="/bg/uslugi/seo/">локално SEO</a> (от €290/месец с ДДС) оптимизираме Google профила, отзивите и страници по услуга и район, така че вие да излизате, когато някой търси вашия занаят наблизо.</p>""",
  faqs=[
   ("Колко струва сайт за занаятчия или сервиз?", "Стегнат сайт с услуги, обслужван район, снимки от работата и бутон за обаждане започва от €1890 с ДДС. С управление на оферти, поръчки и фактури се преминава към система от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="produzione-industria", related=["artigiani-officine", "servizi-professionali", "immobiliare"],
 ...
 it=dict(
  desc="Portale B2B, catalogo tecnico, ERP di produzione e digitalizzazione processi per aziende manifatturiere. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti industriali</a> (da <strong>€1.575 + IVA</strong>) che comunicano capacit&agrave; produttiva, certificazioni e referenze, con cataloghi tecnici, schede prodotto, download di schede dati e area riservata per clienti e agenti. Multilingua per l'export, con dati strutturati per farti trovare dai buyer internazionali.</p>
<h2>ERP di produzione: il vero salto</h2>
<p>Il cuore &egrave; l'<a href="/servizi/erp/">ERP su misura</a> (da <strong>€5.000</strong>): distinte base, ordini di lavoro, avanzamento produzione, magazzino materie prime e prodotti finiti, fatturazione. Un ERP costruito sui tuoi processi &mdash; non un pacchetto da adattare a forza &mdash; ti dice il costo reale di ogni commessa, i colli di bottiglia e le scorte. Il nostro ERP &egrave; gi&agrave; in produzione presso un costruttore industriale.</p>
<h2>Portali B2B e configuratori</h2>
<p>Per chi vende su listino complesso, un portale B2B con area riservata, listini personalizzati per cliente e configuratore di prodotto trasforma le richieste in ordini gi&agrave; corretti: il cliente compone l'articolo, il sistema calcola prezzo e distinta, l'ordine entra pulito nell'ERP. Con un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) gli operatori aggiornano la produzione dal reparto.</p>
<h2>Farsi trovare dai buyer</h2>
<p>Anche nel B2B la ricerca &egrave; il primo passo: &laquo;fornitore [componente]&raquo;, &laquo;produzione conto terzi [settore]&raquo;. Con la <a href="/servizi/seo/">SEO tecnica</a> (da €242/mese + IVA) e contenuti mirati ci facciamo trovare da chi cerca esattamente ci&ograve; che produci, nei mercati che ti interessano.</p>""",
  faqs=[
   ("Quanto costa digitalizzare un'azienda di produzione?", "Il sito B2B con catalogo parte da €1.575 + IVA; il vero investimento è l'ERP di produzione su misura, da €5.000, che dipende dai processi da digitalizzare. Partiamo da un'analisi gratuita per dimensionare il progetto."),
 ...
 en=dict(
  desc="B2B portal, technical catalog, production ERP and process digitalization for manufacturers. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">industrial websites</a> (from <strong>€1,575 + VAT</strong>) that communicate production capacity, certifications and references, with technical catalogs, product pages, datasheet downloads and a reserved area for clients and agents. Multilingual for export, with structured data so international buyers find you.</p>
<h2>Production ERP: the real leap</h2>
<p>The core is the <a href="/en/services/erp/">custom ERP</a> (from <strong>€5,000</strong>): bills of materials, work orders, production progress, raw-material and finished-goods stock, invoicing. An ERP built on your processes &mdash; not a package forced to fit &mdash; tells you the real cost of every job, the bottlenecks and the stock. Our ERP already runs in production at an industrial manufacturer.</p>
<h2>B2B portals and configurators</h2>
<p>For those selling on complex price lists, a B2B portal with a reserved area, per-customer pricing and a product configurator turns requests into already-correct orders: the customer builds the item, the system calculates price and BOM, and the order enters the ERP clean. With an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) operators update production from the shop floor.</p>
<h2>Getting found by buyers</h2>
<p>In B2B too, search is the first step: &laquo;supplier [component]&raquo;, &laquo;contract manufacturing [sector]&raquo;. With <a href="/en/services/seo/">technical SEO</a> (from €242/month + VAT) and targeted content we get you found by those searching for exactly what you produce, in the markets that matter to you.</p>""",
  faqs=[
   ("How much does it cost to digitalize a manufacturing company?", "The B2B site with a catalog starts at €1,575 + VAT; the real investment is the custom production ERP, from €5,000, which depends on the processes to digitalize. We start with a free analysis to size the project."),
 ...
 bg=dict(
  desc="B2B портал, технически каталог, производствен ERP и дигитализация на процеси за производствени фирми. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изработваме <a href="/bg/uslugi/web-razrabotka/">индустриални сайтове</a> (от <strong>€1890 с ДДС</strong>), които представят производствен капацитет, сертификати и референции, с технически каталози, продуктови страници, изтегляне на технически данни и защитена зона за клиенти и агенти. Многоезични за износ, със структурирани данни, за да ви намират международните купувачи.</p>
<h2>Производствен ERP: истинската крачка</h2>
<p>Ядрото е <a href="/bg/uslugi/erp/">ERP по поръчка</a> (от <strong>€5000</strong>): спецификации, работни поръчки, ход на производството, склад за суровини и готова продукция, фактуриране. ERP, изграден по вашите процеси &mdash; а не пакет, натъкмен насила &mdash; ви показва реалната себестойност на всяка поръчка, тесните места и наличностите. Нашият ERP вече работи при индустриален производител.</p>
<h2>B2B портали и конфигуратори</h2>
<p>За продаващите по сложни ценови листи, B2B портал със защитена зона, персонални цени по клиент и продуктов конфигуратор превръща запитванията във вече коректни поръчки: клиентът сглобява артикула, системата изчислява цена и спецификация, а поръчката влиза чиста в ERP. С <a href="/bg/uslugi/mobilni-prilozheniya/">приложение</a> (от <strong>€3000</strong>) операторите обновяват производството от цеха.</p>
<h2>Да ви намират купувачите</h2>
<p>И в B2B търсенето е първата стъпка: &laquo;доставчик [компонент]&raquo;, &laquo;производство на ишлеме [сектор]&raquo;. С <a href="/bg/uslugi/seo/">техническо SEO</a> (от €290/месец с ДДС) и целенасочено съдържание ви правим намираеми от търсещите точно това, което произвеждате, на пазарите, които ви интересуват.</p>""",
  faqs=[
   ("Колко струва дигитализацията на производствена фирма?", "B2B сайтът с каталог започва от €1890 с ДДС; истинската инвестиция е производственият ERP по поръчка, от €5000, който зависи от процесите за дигитализация. Започваме с безплатен анализ за оразмеряване на проекта."),
...
dict(slug="scuole-formazione", related=["servizi-professionali", "palestre-fitness", "studi-medici"],
 ...
 it=dict(
  desc="Sito, iscrizioni online, piattaforma corsi (LMS) e gestione allievi per scuole, academy e centri di formazione. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per scuole e academy</a> (da <strong>€1.575 + IVA</strong>) con catalogo corsi, calendario, docenti, costi trasparenti e testimonianze. Ogni corso ha la sua pagina ottimizzata e un modulo di iscrizione o richiesta info che converte l'interesse in candidatura, senza far scaricare moduli PDF da stampare.</p>
<h2>Iscrizioni e pagamenti online</h2>
<p>Le iscrizioni online con pagamento (o acconto) riducono le pratiche e i posti persi: l'allievo si iscrive quando &egrave; motivato, tu ricevi i dati gi&agrave; ordinati. Per la formazione a pagamento, un piccolo <a href="/servizi/ecommerce/">e-commerce di corsi</a> (da <strong>€1.825 + IVA</strong>) gestisce vendita, coupon e accessi.</p>
<h2>Piattaforma e-learning e gestione allievi</h2>
<p>Per chi eroga corsi online serve una piattaforma vera: lezioni, materiali, quiz, attestati e monitoraggio dei progressi. Un <a href="/servizi/erp/">LMS/gestionale su misura</a> (da <strong>€5.000</strong>) unisce e-learning e amministrazione: anagrafica allievi, presenze, pagamenti, certificati. Con un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) gli studenti seguono i corsi da mobile e ricevono notifiche.</p>
<h2>Farsi trovare da chi cerca corsi</h2>
<p>Le ricerche formative sono specifiche: &laquo;corso [materia] [citt&agrave;]&raquo;, &laquo;certificazione [ambito]&raquo;. Con la <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA) creiamo pagine per corso e per citt&agrave; e contenuti utili che dimostrano competenza, cos&igrave; intercetti chi cerca esattamente ci&ograve; che insegni.</p>""",
  faqs=[
   ("Quanto costa un sito per una scuola o un centro di formazione?", "Un sito con catalogo corsi, calendario e iscrizioni parte da €1.575 + IVA. Con vendita corsi online si aggiunge da €1.825 + IVA e con piattaforma e-learning e gestione allievi si arriva a un LMS su misura da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Website, online enrollment, course platform (LMS) and student management for schools, academies and training centers. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">websites for schools and academies</a> (from <strong>€1,575 + VAT</strong>) with a course catalog, calendar, tutors, transparent costs and testimonials. Each course has its own optimized page and an enrollment or info-request form that converts interest into an application, without making people download PDF forms to print.</p>
<h2>Online enrollment and payments</h2>
<p>Online enrollment with payment (or deposit) cuts paperwork and lost seats: the learner signs up while motivated, you receive the data already organized. For paid training, a small <a href="/en/services/ecommerce/">course e-commerce</a> (from <strong>€1,825 + VAT</strong>) handles sales, coupons and access.</p>
<h2>E-learning platform and student management</h2>
<p>For online courses you need a real platform: lessons, materials, quizzes, certificates and progress tracking. A <a href="/en/services/erp/">custom LMS/management system</a> (from <strong>€5,000</strong>) unites e-learning and administration: student records, attendance, payments, certificates. With an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) students follow courses on mobile and receive notifications.</p>
<h2>Getting found by course seekers</h2>
<p>Training searches are specific: &laquo;[subject] course [city]&raquo;, &laquo;[field] certification&raquo;. With <a href="/en/services/seo/">SEO</a> (from €242/month + VAT) we create per-course and per-city pages and useful content that proves expertise, so you capture people searching for exactly what you teach.</p>""",
  faqs=[
   ("How much does a school or training center website cost?", "A site with a course catalog, calendar and enrollment starts at €1,575 + VAT. Online course sales add from €1,825 + VAT, and an e-learning platform with student management brings a custom LMS from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Сайт, онлайн записване, платформа за курсове (LMS) и управление на курсисти за училища, академии и центрове за обучение. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изработваме <a href="/bg/uslugi/web-razrabotka/">сайтове за училища и академии</a> (от <strong>€1890 с ДДС</strong>) с каталог курсове, календар, преподаватели, прозрачни цени и отзиви. Всеки курс има своя оптимизирана страница и форма за записване или запитване, която превръща интереса в кандидатура, без да карате хората да свалят PDF формуляри за печат.</p>
<h2>Записване и плащания онлайн</h2>
<p>Онлайн записването с плащане (или капаро) намалява документацията и изгубените места: курсистът се записва, докато е мотивиран, а вие получавате данните вече подредени. За платено обучение малък <a href="/bg/uslugi/ecommerce/">магазин за курсове</a> (от <strong>€2190 с ДДС</strong>) управлява продажбите, купоните и достъпа.</p>
<h2>Платформа за е-обучение и управление на курсисти</h2>
<p>За онлайн курсове трябва истинска платформа: уроци, материали, тестове, сертификати и проследяване на прогреса. <a href="/bg/uslugi/erp/">LMS/управленска система по поръчка</a> (от <strong>€5000</strong>) обединява е-обучението и администрацията: регистър на курсистите, посещаемост, плащания, сертификати. С <a href="/bg/uslugi/mobilni-prilozheniya/">приложение</a> (от <strong>€3000</strong>) курсистите следят курсовете от телефона и получават известия.</p>
<h2>Да ви намират търсещите курсове</h2>
<p>Обучителните търсения са конкретни: &laquo;курс [предмет] [град]&raquo;, &laquo;сертификат [област]&raquo;. С <a href="/bg/uslugi/seo/">SEO</a> (от €290/месец с ДДС) създаваме страници по курс и по град и полезно съдържание, което доказва компетентност, така хващате търсещите точно това, което преподавате.</p>""",
  faqs=[
   ("Колко струва сайт за училище или център за обучение?", "Сайт с каталог курсове, календар и записване започва от €1890 с ДДС. Онлайн продажба на курсове добавя от €2190 с ДДС, а платформа за е-обучение с управление на курсисти носи LMS по поръчка от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="ecommerce-alimentari", related=["ristoranti", "moda-abbigliamento", "artigiani-officine"],
 ...
 it=dict(
  desc="E-commerce per prodotti alimentari, gestione lotti, scadenze e spedizioni refrigerate per produttori, cantine e negozi di gastronomia. Da €1.825 + IVA, preventivo gratuito in 24 ore.",
...
<p>Le ricerche food sono ad alta intenzione: &laquo;comprare [prodotto tipico] online&raquo;, &laquo;[specialit&agrave;] spedizione&raquo;. Con la <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA) ottimizziamo schede prodotto, dati strutturati e contenuti su origine e ricette, cos&igrave; intercetti chi cerca proprio ci&ograve; che produci, anche fuori dalla tua regione.</p>""",
  faqs=[
   ("Quanto costa un e-commerce per prodotti alimentari?", "Un e-commerce food con gestione scadenze, allergeni e spedizioni parte da €1.825 + IVA. Con tracciabilità lotti e gestione magazzino integrata si aggiunge un gestionale da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="E-commerce for food products, batch and expiry management and refrigerated shipping for producers, wineries and delis. From €1,825 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/ecommerce/">food e-commerce</a> (from <strong>€1,825 + VAT</strong>) with variable-weight products, compliant allergen and label info, expiry dates, sale by pack or loose, and refrigerated courier shipping where needed. We integrate payments, zone-based shipping calculation and fresh-order handling with dedicated delivery days.</p>
<h2>Batches, expiry and traceability</h2>
<p>Food safety requires traceability. A <a href="/en/services/erp/">management system</a> (from <strong>€5,000</strong>) linked to the store handles batches, expiry, stock and traceability: you know what you shipped, to whom and with which batch, and you sell what expires first. That's what separates a serious seller from an improvised one.</p>
...
<p>Food searches are high-intent: &laquo;buy [regional product] online&raquo;, &laquo;[specialty] shipping&raquo;. With <a href="/en/services/seo/">SEO</a> (from €242/month + VAT) we optimize product pages, structured data and content about origin and recipes, so you capture people searching for exactly what you produce, even beyond your region.</p>""",
  faqs=[
   ("How much does a food e-commerce cost?", "A food e-commerce with expiry, allergen and shipping management starts at €1,825 + VAT. With batch traceability and integrated stock management, a system from €5,000 is added. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Онлайн магазин за хранителни продукти, управление на партиди, срокове и хладилни доставки за производители, винарни и деликатесни магазини. От €2190 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изработваме <a href="/bg/uslugi/ecommerce/">онлайн магазини за храна</a> (от <strong>€2190 с ДДС</strong>) с продукти с променливо тегло, коректна информация за алергени и етикети, срокове на годност, продажба на опаковка или насипно и доставка с хладилен куриер, където трябва. Интегрираме плащания, изчисляване на доставка по зона и обработка на пресни поръчки със специални дни за доставка.</p>
<h2>Партиди, срокове и проследимост</h2>
<p>Безопасността на храните изисква проследимост. <a href="/bg/uslugi/erp/">Управленска система</a> (от <strong>€5000</strong>), свързана с магазина, управлява партиди, срокове, наличности и проследимост: знаете какво сте изпратили, на кого и с коя партида, и продавате първо това, което изтича първо. Това отличава сериозния продавач от импровизиращия.</p>
...
<p>Търсенията за храна са с висока намереност: &laquo;купи [местен продукт] онлайн&raquo;, &laquo;[специалитет] доставка&raquo;. С <a href="/bg/uslugi/seo/">SEO</a> (от €290/месец с ДДС) оптимизираме продуктови страници, структурирани данни и съдържание за произход и рецепти, така хващате търсещите точно това, което произвеждате, дори извън вашия регион.</p>""",
  faqs=[
   ("Колко струва онлайн магазин за хранителни продукти?", "Хранителен онлайн магазин с управление на срокове, алергени и доставки започва от €2190 с ДДС. С проследимост на партиди и интегрирано управление на склада се добавя система от €5000. Безплатна оферта до 24 часа."),
...
dict(slug="servizi-professionali", related=["avvocati", "studi-medici", "immobiliare"],
 ...
 it=dict(
  desc="Sito professionale, prenotazione consulenze, gestione clienti e fatturazione per consulenti, commercialisti, agenzie e studi. Da €658 + IVA, preventivo gratuito in 24 ore.",
...
<p>Realizziamo <a href="/servizi/sviluppo-siti-web/">siti per professionisti</a> (da <strong>€1.575 + IVA</strong>) chiari e credibili: servizi, casi e risultati, chi sei, testimonianze e un blog che dimostra competenza. Il design comunica posizionamento e prezzo percepito: un sito curato attira clienti migliori e giustifica tariffe pi&ugrave; alte.</p>
...
<p>Il tempo &egrave; il tuo prodotto: sprecarlo in amministrazione &egrave; costoso. Un <a href="/servizi/erp/">gestionale su misura</a> (da <strong>€5.000</strong>) tiene insieme clienti, progetti, ore, scadenze, documenti e fatturazione. Sai quanto rende ogni cliente e ogni progetto, e la fatturazione smette di essere una corsa a fine mese. Con un'<a href="/servizi/app-mobile/">app</a> (da <strong>€3.000</strong>) segui tutto anche in mobilit&agrave;.</p>
<h2>Farsi trovare per la propria competenza</h2>
<p>I clienti cercano soluzioni a problemi precisi: &laquo;consulente [ambito] [citt&agrave;]&raquo;, &laquo;come fare [problema]&raquo;. Con la <a href="/servizi/seo/">SEO</a> (da €242/mese + IVA) creiamo pagine per servizio e contenuti che rispondono a queste domande, posizionandoti come l'esperto a cui rivolgersi, non come un nome tra tanti.</p>""",
  faqs=[
   ("Quanto costa un sito per un professionista o uno studio?", "Un sito professionale con servizi, casi e modulo consulenza parte da €1.575 + IVA. Con gestionale per clienti, progetti e fatturazione si passa a un progetto su misura da €5.000. Preventivo gratuito in 24 ore."),
 ...
 en=dict(
  desc="Professional website, consultation booking, client management and invoicing for consultants, accountants, agencies and firms. From €658 + VAT, free quote within 24 hours.",
...
<p>We build <a href="/en/services/web-development/">websites for professionals</a> (from <strong>€1,575 + VAT</strong>) that are clear and credible: services, cases and results, who you are, testimonials and a blog that demonstrates expertise. Design communicates positioning and perceived price: a polished site attracts better clients and justifies higher fees.</p>
...
<p>Time is your product: wasting it on admin is expensive. A <a href="/en/services/erp/">custom management system</a> (from <strong>€5,000</strong>) holds clients, projects, hours, deadlines, documents and invoicing together. You know how much each client and project makes, and invoicing stops being a month-end scramble. With an <a href="/en/services/mobile-apps/">app</a> (from <strong>€3,000</strong>) you track everything on the move.</p>
<h2>Getting found for your expertise</h2>
<p>Clients search for solutions to precise problems: &laquo;[field] consultant [city]&raquo;, &laquo;how to [problem]&raquo;. With <a href="/en/services/seo/">SEO</a> (from €242/month + VAT) we create per-service pages and content that answers these questions, positioning you as the expert to turn to, not one name among many.</p>""",
  faqs=[
   ("How much does a website for a professional or firm cost?", "A professional site with services, cases and a consultation form starts at €1,575 + VAT. With client, project and invoicing management it becomes a custom project from €5,000. Free quote within 24 hours."),
 ...
 bg=dict(
  desc="Професионален сайт, записване на консултации, управление на клиенти и фактуриране за консултанти, счетоводители, агенции и кантори. От €790 с ДДС, безплатна оферта до 24 часа.",
...
<p>Изработваме <a href="/bg/uslugi/web-razrabotka/">сайтове за специалисти</a> (от <strong>€1890 с ДДС</strong>), ясни и убедителни: услуги, казуси и резултати, кой сте, отзиви и блог, който доказва компетентност. Дизайнът излъчва позициониране и възприемана цена: издържан сайт привлича по-добри клиенти и оправдава по-високи тарифи.</p>
