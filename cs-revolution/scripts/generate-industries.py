...
L = {
 "it": dict(
   prefix="", urlbase="/settori/", og="og-image.png", locale="it_IT",
 ...
 "en": dict(
   prefix="/en", urlbase="/en/industries/", og="og-image-en.png", locale="en_US",
 ...
 "bg": dict(
   prefix="/bg", urlbase="/bg/branshove/", og="og-image-bg.png", locale="bg_BG",
