...
T = {
 "it": dict(
   ...
   desc="Prezzi trasparenti, almeno il 15% sotto il mercato: landing page {start} €, sito aziendale {business} €, e-commerce {ecommerce} €. IVA esclusa: esente solo per le aziende con partita IVA, i privati pagano l'IVA. Preventivo in 24 ore.",
   ...
   vat=[("Chi non paga l'IVA", "Solo ed esclusivamente le aziende: una società o un professionista con partita IVA valida. Se sei un privato (persona fisica), ai prezzi indicati si aggiunge sempre l'IVA del 20%."),
        ("Aziende UE fuori dalla Bulgaria", "Fatturiamo SENZA IVA con il meccanismo dell'inversione contabile (reverse charge) — art. 196 della Direttiva 2006/112/CE (art. 21, c. 2 della legge IVA bulgara). Serve una partita IVA valida e verificabile su VIES; l'IVA la assolvi tu nel tuo Paese. Senza partita IVA valida si applica l'IVA del 20%."),
        ("Aziende fuori dall'UE e clienti in Bulgaria", "Aziende extra-UE: il luogo della prestazione è fuori dalla Bulgaria, nessuna IVA bulgara. Clienti in Bulgaria (aziende e privati): +20% di IVA, fattura in euro.")],
   vat_note="In sintesi: nessuna IVA solo se il cliente è un'azienda con partita IVA valida; i privati, ovunque si trovino, pagano l'IVA del 20%. Non è consulenza fiscale — in caso di dubbio verifica con il tuo commercialista.",
   ...
   faq=[("Perché costate meno delle agenzie?", "Niente affitto di uffici, niente venditori o project manager tra te e lo sviluppatore. Lavoriamo con componenti collaudati e test automatici — per questo un sito richiede giorni, non mesi."),
        ...
        ("Come si paga e che documenti ricevo?", "Bonifico o carta. Proforma all'avvio, fattura per ogni pagamento — con reverse charge per le aziende UE con partita IVA. Ai privati la fattura include l'IVA del 20%."),
 ...
 "en": dict(
   ...
   desc="Transparent prices at least 15% below market: landing page €{start}, business website €{business}, online shop €{ecommerce}. Excl. VAT: exempt only for VAT-registered companies, private individuals pay VAT. Quote within 24 hours.",
   ...
   vat=[("Who does not pay VAT", "Only and exclusively companies: a business or a professional with a valid VAT number. If you are a private individual, 20% VAT is always added to the prices shown."),
        ("EU companies outside Bulgaria", "We invoice WITHOUT VAT under the reverse charge mechanism — Article 196 of Council Directive 2006/112/EC (Art. 21(2) of the Bulgarian VAT Act). A valid VAT number verifiable on VIES is required; you self-account for VAT in your own country. Without a valid VAT number, 20% VAT applies."),
        ("Companies outside the EU and clients in Bulgaria", "Non-EU companies: the place of supply is outside Bulgaria, no Bulgarian VAT. Clients in Bulgaria (companies and individuals): +20% VAT, invoice in euro.")],
   vat_note="In short: no VAT only if the client is a company with a valid VAT number; private individuals, wherever they are, pay 20% VAT. This is not tax advice — when in doubt, check with your accountant.",
   ...
   faq=[("Why are you cheaper than agencies?", "No office rent, no salespeople or project managers between you and the developer. We work with proven, ready components and automated testing — that is why a website takes days, not months."),
        ...
        ("How do I pay and what documents do I get?", "Bank transfer or card. Pro-forma at start, an invoice for every payment — with reverse charge for VAT-registered EU companies. Invoices to private individuals include 20% VAT."),
