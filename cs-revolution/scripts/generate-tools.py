...
L = {
 "it": dict(
   ...
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">HOME</a><a href="/chi-siamo/">CHI SIAMO</a><a href="/servizi/sviluppo-siti-web/">SERVIZI</a><a href="/strumenti/">STRUMENTI</a><a href="/prezzi/">PREZZI</a><a href="/contatti/">CONTATTI</a></div></nav>',
 ...
 "en": dict(
   prefix="/en", og="og/og-strumenti-en.png", locale="en_US", numloc="en-US",
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">HOME</a><a href="/en/about/">ABOUT</a><a href="/en/services/web-development/">SERVICES</a><a href="/en/tools/">TOOLS</a><a href="/en/pricing/">PRICING</a><a href="/en/contact/">CONTACT</a></div></nav>',
 ...
 "bg": dict(
   prefix="/bg", og="og/og-strumenti-bg.png", locale="bg_BG", numloc="bg-BG",
   nav='<nav class="nav"><a href="/"><img src="/logo.png" alt="Carbon Stealth VCC" width="70" height="30" decoding="async"></a><div><a href="/">ГЛАВНА</a><a href="/bg/za-nas/">ЗА НАС</a><a href="/bg/uslugi/web-razrabotka/">УСЛУГИ</a><a href="/bg/instrumenti/">ИНСТРУМЕНТИ</a><a href="/bg/ceni/">ЦЕНИ</a><a href="/bg/kontakti/">КОНТАКТИ</a></div></nav>',
 ...
 lang=dict(
  it=dict(
   ...
   intro='<p>Questo <strong>calcolatore di preventivo</strong> ti d&agrave; una stima immediata del costo del tuo sito web o software. Scegli il tipo di progetto, indica il numero di pagine o prodotti e seleziona le funzionalit&agrave; che ti servono: il prezzo stimato si aggiorna in tempo reale, direttamente nel browser e senza registrazione.</p>'
         '<p>Le stime si basano sui nostri prezzi reali di partenza: sito vetrina da €1.890, e-commerce da €2.190, software su misura da €2.000, app mobile da €3.000 ed ERP da €5.000. Per un preventivo esatto guarda i nostri servizi di <a href="/servizi/sviluppo-siti-web/">sviluppo siti web</a>, <a href="/servizi/ecommerce/">e-commerce</a> e <a href="/servizi/sviluppo-software/">software su misura</a>, oppure <a href="/contatti/">contattaci</a>.</p>',
   ...
   faqs=[
    ...
    ("Quanto costa davvero un sito web?", "Un sito vetrina parte da €1.890, un e-commerce da €2.190 e un software su misura da €2.000. Il prezzo finale dipende da pagine, funzionalita e integrazioni: usa il calcolatore per una prima stima realistica."),
   ]),
  en=dict(
   ...
   intro='<p>This free <strong>quote calculator</strong> gives you an instant estimate of your website or software cost. Choose the project type, set the number of pages or products and select the features you need: the estimated price updates live, right in your browser and with no sign-up.</p>'
         '<p>The estimates are based on our real starting prices: brochure site from €1,890, e-commerce from €2,190, custom software from €2,000, mobile app from €3,000 and ERP from €5,000. For an exact quote see our <a href="/en/services/web-development/">web development</a>, <a href="/en/services/ecommerce/">e-commerce</a> and <a href="/en/services/software-development/">custom software</a> services, or <a href="/en/contact/">get in touch</a>.</p>',
   ...
   faqs=[
    ...
    ("How much does a website really cost?", "A brochure site starts at €1,890, an e-commerce at €2,190 and custom software at €2,000. The final price depends on pages, features and integrations: use the calculator for a realistic first estimate."),
   ]),
  bg=dict(
   ...
   faqs=[
    ...
    ("Колко реално струва един сайт?", "Визитен сайт започва от €1890, онлайн магазин от €2190, а софтуер по поръчка от €2000. Крайната цена зависи от страници, функции и интеграции: използвайте калкулатора за реалистична първа оценка."),
   ]),
 )),
