 ...
 lang=dict(
  it=dict(
   ...
   ui=dict(type_label="Tipo di progetto",
     ...
     options=[("SEO",242),("Multilingua",292),("Blog",100),("Integrazione pagamenti",500),("Hosting gestito",156)],
  ...
  en=dict(
   ...
   ui=dict(type_label="Project type",
     ...
     options=[("SEO",242),("Multilingual",292),("Blog",100),("Payment integration",500),("Managed hosting",156)],
   ...
   faqs=[
    ...
    ("How much does a website really cost?", "A brochure site starts at €1,575 + VAT, an e-commerce at €1,825 + VAT and custom software at €2,000. The final price depends on pages, features and integrations: use the calculator for a realistic first estimate."),
   ]),
  bg=dict(
   ...
   faqs=[
    ...
    ("Колко реално струва един сайт?", "Визитен сайт започва от €1890 с ДДС, онлайн магазин от €2190 с ДДС, а софтуер по поръчка от €2000. Крайната цена зависи от страници, функции и интеграции: използвайте калкулатора за реалистична първа оценка."),
   ]),
 )),
