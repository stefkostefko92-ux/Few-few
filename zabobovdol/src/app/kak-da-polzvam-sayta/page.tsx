...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Кратко въведение за сайта „За Бобов дол“ — как да търсите, да слушате текста на глас, да уголемите буквите, да питате помощника и да намерите важните телефони. Просто и спокойно.",
...
const STEPS: { icon: typeof Type; title: string; body: React.ReactNode }[] = [
  ...
  {
    icon: Ear,
    title: "Слушайте текста на глас",
    body: (
      <>
        Не обичате да четете дребен текст? В лентата най-горе натиснете{" "}
        <strong>„Чети на глас“</strong> и сайтът ще ви прочете страницата с приятен глас. Натиснете
        пак, за да спре.
      </>
    ),
  },
