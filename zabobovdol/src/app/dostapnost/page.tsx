...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Как да ползвате сайта „За Бобов дол“ по-лесно: уголемяване на текста, висок контраст, тъмен режим и по-големи бутони. Връзка с институции без обаждане за хора с увреден слух и достъп до 112 за глухи и хора с говорни затруднения.",
  path: "/dostapnost",
});
...
const FAQ: { question: string; answerText: string }[] = [
  {
    ...
    answerText:
      "В лентата „Достъпност“ най-горе натиснете едно от трите „А“ — нормален, голям или много голям. На телефон лентата е свита — първо натиснете „Покажи“. Изборът се запомня за следващите посещения.",
  },
  {
      ...
      <div className="container-content space-y-12 py-10">
        ...
        <section>
          ...
          <p className="mb-5 max-w-2xl text-slate-600">
            Всички тези бутони са в <strong>лентата „Достъпност“</strong>{" "}
            най-горе на всяка страница, над менюто. На телефон лентата е
            свита, за да не заема място — натиснете „Покажи“ в нея. Изборът ви се
            запомня за следващите посещения.
          </p>
