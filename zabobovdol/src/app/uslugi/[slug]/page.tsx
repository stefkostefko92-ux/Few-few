      ...
      <div className="container-content grid gap-8 py-10 lg:grid-cols-[1fr,18rem]">
        ...
        <aside className="space-y-3">
          <div className="card space-y-3">
            ...
            {s.phone2 && (
              <div>
                <div className="text-sm text-slate-600">Втори телефон</div>
            ...
            {s.address && (
              <div>
                <div className="text-sm text-slate-600">Адрес</div>
                <div className="text-slate-700">{s.address}</div>
              </div>
            )}
            {s.hours && (
              <div>
                <div className="text-sm text-slate-600">Работно време</div>
                <div className="text-slate-700">{s.hours}</div>
              </div>
            )}
            {s.email && (
              <div>
                <div className="text-sm text-slate-600">Имейл</div>
            ...
            {s.website && (
              <div>
                <div className="text-sm text-slate-600">Уебсайт</div>
                <a
                  href={s.website}
                  target="_blank"
