...
export const RESOURCES: Resource[] = [
  ...
  },
  {
    key: "izmami",
    model: "scamAlert",
    labelSingular: "Предупреждение за измама",
    labelPlural: "Измами (предупреждения)",
    titleField: "title",
    slugFrom: "title",
    defaultSort: { field: "order", dir: "asc" },
    fields: [
      { name: "title", label: "Заглавие (каква е измамата)", type: "text", required: true, listVisible: true },
      { name: "slug", label: "URL адрес (slug)", type: "text" },
      { name: "summary", label: "Кратко описание (за картата/лентата)", type: "textarea", fullWidth: true, help: "Едно-две изречения с предупреждение." },
      { name: "body", label: "Подробности и съвети (Markdown)", type: "markdown", fullWidth: true },
      {
        name: "severity",
        label: "Ниво",
        type: "select",
        ...
        options: [
          ...
          { value: "danger", label: "Опасно (силно предупреждение)" },
        ],
      },
      { name: "pinned", label: "Закачи като лента на началната страница", type: "boolean", listVisible: true },
      { name: "order", label: "Подредба", type: "number" },
      { name: "published", label: "Публикувано", type: "boolean", listVisible: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "source", label: "Източник (за внесени новини)", type: "text" },
      { name: "sourceUrl", label: "Линк към оригинала", type: "text" },
      { name: "sourceDate", label: "Дата от източника", type: "datetime" },
  ...
  },
  {
    key: "prekysvaniya",
    model: "outage",
    labelSingular: "Прекъсване (ток/вода)",
    labelPlural: "Прекъсвания на ток и вода",
    titleField: "area",
    slugFrom: "area",
    defaultSort: { field: "startAt", dir: "desc" },
    fields: [
      { name: "area", label: "Засегнат район (улици/квартали)", type: "text", required: true, listVisible: true },
      { name: "slug", label: "URL адрес (slug)", type: "text" },
      {
        name: "utility",
        label: "Какво спира",
      ...
      { name: "planned", label: "Планово (изключете за авария)", type: "boolean", listVisible: true },
      { name: "startAt", label: "От кога", type: "datetime" },
      { name: "endAt", label: "Докога (очаквано)", type: "datetime" },
      { name: "note", label: "Подробности (Markdown, по избор)", type: "markdown", fullWidth: true },
      { name: "published", label: "Публикувано", type: "boolean", listVisible: true },
    ],
  },
  {
    ...
    labelSingular: "Контактно съобщение",
    ...
    fields: [
      ...
      { name: "email", label: "Имейл", type: "text" },
      { name: "phone", label: "Телефон", type: "text" },
      { name: "message", label: "Съобщение", type: "textarea", fullWidth: true },
      { name: "handled", label: "Обработено", type: "boolean", listVisible: true },
    ],
  },
  {
    key: "galeriya",
