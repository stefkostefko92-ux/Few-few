...
# Тайните (AUTH_SECRET, паролите на базата и админа) — само за собственика.
# `cp` наследява 644 от .env.example, тоест всеки потребител на сървъра можеше
# да ги прочете. Налагаме 600 и на вече съществуващ файл.
chmod 600 "$ENV_FILE"
