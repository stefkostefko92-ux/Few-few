...
(грундирани отговори от сайта, без AI).

С включен ключ помощникът:
...
Моделът се избира с `ANTHROPIC_MODEL` (по подразбиране `claude-opus-4-8` за
най-добри отговори). За по-нисък разход сложете `claude-haiku-4-5`.
