/**
 * Extended player pool — populates the arena leaderboard and merchant
 * marketplace so a fresh server feels lived-in. Each entry has its own
 * statline, gear tier, and bio. Generated names mix Bulgarian, Italian,
 * Slavic, Romance, and generic fantasy roots so no single archetype
 * dominates. Levels lean low/mid with a few veterans at the top.
 */
...
// Brief, varied bios. Empty bio is also realistic — most casual players don't write one.
const BIOS: string[] = [
  '',
  '',
  '',
