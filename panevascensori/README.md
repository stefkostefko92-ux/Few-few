...
```
Questo crea:
- Admin `info@panevascensori.it` / `Panev2024!` (**da cambiare al primo login**)
...
- **Password default:** `Panev2024!` — **cambiarla dal primo accesso** (Impostazioni → Cambia Password)
...
curl -c /tmp/cookies -X POST https://www.panevascensori.it/api/admin/login \
     ...
     -d '{"email":"info@panevascensori.it","password":"Panev2024!"}'
