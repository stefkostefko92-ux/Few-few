...
/* desktop: далеч вдясно, вертикално центриран. theme носи margin-left:auto и е
   последен (order:2) → auto-полето го изтласква до десния ръб; навигацията (order:1)
   се свива и пренася вътрешно, вместо да избута бутона на нов ред. */
@media(min-width:901px){
  nav.main{order:1;margin-left:0}
