...
(dichiarate qui sotto) sono volutamente prudenti. L'ordine della tabella riflette solo il <strong>numero di spie
da verificare</strong>, non un giudizio di gravità né di legalità.</p>
...
<br><strong>Attenzione ai dati di partenza:</strong> il tipo di procedura è dichiarato dalle stazioni appaltanti e in
ANAC è spesso registrato in modo impreciso (una convenzione Consip può risultare come «affidamento diretto»).
Una spia «senza gara» accesa può quindi riflettere un difetto di registrazione, non un reale mancato confronto
competitivo. Metodo completo → <a href="metodologia.html">metodologia</a>.</div>
