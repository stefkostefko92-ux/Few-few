...
- **⚙️ Страница с настройки** — статистика, превключватели за функциите, управление на allowlist-а и скритите елементи.
- **Popup за управление** — глобален и per-site toggle, брояч на блокираните реклами, бутони за picker и настройки.
