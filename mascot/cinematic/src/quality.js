// Quality tiers and the frame-time governor that holds the frame rate at 60 fps or better by
// moving the internal render resolution instead of switching effects off.
// Adapted from boy/src/quality.js: same governor, tiers trimmed to what a single small studio
// subject needs (no rain/reflections budget).

export const QUALITY = {
  low: { msaa: 0, dofTaps: 0, ao: false, streaks: false, maxDPR: 1.0, shadow: false },
...
// Too many misses in the window lowers the scale by 15%; a clean window raises it by 8%, but
// not back above a scale that just failed until `holdMs` has passed.
