...
// Desk-set surfaces (wood/leather/window) moved to desk-textures.js — this file stays under the
// house 300-line cap and keeps to the mascot's own material bakes.
