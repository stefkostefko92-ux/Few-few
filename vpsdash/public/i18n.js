...
// Последните три носят ЧУЖД изход (съобщение на docker/systemd/journalctl).
// Той не се превежда — и не бива: това е дословният текст, който човек ще
// потърси. Превежда се само нашият префикс, за да не остане цялото изречение
// на български пред англоговорящ.
const COMPOSITE_PREFIXES = [
  'Възстановено: ', 'Провалена задача: ', '→ ',
  'Не мога да проверя: ', 'docker не отговори: ', 'journalctl не отговори: ',
];
