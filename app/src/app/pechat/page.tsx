...
export const metadata: Metadata = buildMetadata({
  title: "Важни телефони за печат — Дупница",
  description:
    "Списък с важни телефони за Дупница, готов за печат и закачане у дома. С QR код към сайта за повече информация.",
  path: "/pechat",
});
    ...
    <div className="container-content py-8">
      ...
      <div className="print-sheet mx-auto max-w-2xl rounded-xl border border-slate-300 bg-white p-8 shadow-sm">
        <div className="flex items-center gap-3 border-b-2 border-slate-200 pb-4">
          ...
          <img src="/brand/bobov-dol-grb.png" alt="Герб на Дупница" width={40} height={58} className="h-14 w-auto" />
          <div>
        ...
        <div className="mt-6 flex items-center gap-4 border-t-2 border-slate-200 pt-4">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/qr-zadupnitsa.png" alt="QR код към сайта" width={90} height={90} className="h-24 w-24" />
