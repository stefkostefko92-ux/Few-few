...
export const metadata: Metadata = buildMetadata({
  title: "Плакат за разпечатване — За Дупница",
  description:
    "Готов за печат плакат (A4) с QR код към сайта „За Дупница“. Разпечатайте и закачете в аптеката, кметството, на спирката или в магазина, за да го видят повече хора.",
  path: "/pechat/plakat",
});
