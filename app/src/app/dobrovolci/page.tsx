...
export const metadata: Metadata = buildMetadata({
  title: "Доброволци в помощ на възрастните хора в Дупница",
  description:
    "Мрежа от доброволци, които безплатно помагат на възрастните хора в Дупница — с телефони, документи, пазар и компания. Запишете се или потърсете помощ.",
  path: "/dobrovolci",
});
  ...
  return (
    <>
      <PageHero
        ...
        intro="Нямаме гише, но имаме хора с добро сърце. Доброволци помагат безплатно на възрастните в Дупница — с телефона и интернет, документи, пазар или просто компания."
      ...
      <div className="container-content py-10">
        ...
        {volunteers.length === 0 ? (
          <EmptyState
            ...
            hint="Бъдете сред първите доброволци в Дупница."
          />
        ) : (
