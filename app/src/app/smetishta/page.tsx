...
export const metadata: Metadata = buildMetadata({
  title: "Сигнали за нерегламентирани сметища в Дупница",
  description:
    "Видяхте незаконно изхвърлени отпадъци в Дупница? Подайте сигнал за нерегламентирано сметище и вижте вече подадените, за да се почисти градът заедно.",
  path: "/smetishta",
});
  ...
  return (
    <>
      <PageHero
        ...
        intro="Видяхте незаконно изхвърлени отпадъци? Подайте сигнал — ще го прегледаме, ще го покажем тук и ще го препратим към общината. Заедно пазим Дупница чист."
