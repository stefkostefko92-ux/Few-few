    ...
    <div className="border-b border-brand-200 bg-brand-50 no-print">
      <div className="container-content flex flex-wrap items-center gap-x-3 gap-y-2 py-2 text-sm">
        ...
        <button
          ...
          className="a11y-btn inline-flex items-center gap-1.5 rounded px-3 py-1.5 font-medium text-brand-800 ring-1 ring-brand-200 transition hover:bg-brand-100"
          title={
            collapsed
              ? "Покажи настройките за достъпност"
              : "Скрий настройките за достъпност"
          }
        >
          <ChevronDown
        ...
        {!collapsed && (
          <>
            ...
            {toggleBtn(
              ...
              "Контраст",
              "Висок контраст за по-добра четимост",
            )}
            {toggleBtn(
              dark,
              toggleDark,
            ...
            {toggleBtn(
              ...
              "По-лесно докосване",
              "По-големи бутони и връзки за по-лесно натискане",
            )}

            <Link
              href="/dostapnost"
              className="a11y-btn ml-auto inline-flex items-center gap-1.5 rounded px-3 py-1.5 font-medium text-brand-800 underline-offset-2 hover:underline"
              title="Декларация и помощ за достъпността"
            >
