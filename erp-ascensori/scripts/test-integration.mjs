...
const env = {
  ...
  // Прозорецът „паралелен таб" при подновяване: в продукция 20 s, тук кратък,
  // за да може тестът да докаже, че СЛЕД него повторната употреба сваля сесията.
  REFRESH_GRAZIA_MS: "1500",
