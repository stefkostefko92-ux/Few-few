...
echo "    TRUSTED_PROXY_HOPS   1 — винаги 1 с нашата конфигурация на Nginx:"
echo "                         proxy_params_erp ЗАДАВА X-Forwarded-For с един"
echo "                         елемент. Зад CDN сложи set_real_ip_from +"
echo "                         real_ip_header CF-Connecting-IP в Nginx, за да е"
echo "                         \$remote_addr истинският клиент — стойността тук"
echo "                         пак остава 1."
