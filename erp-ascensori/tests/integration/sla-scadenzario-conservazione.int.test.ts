...
describe("материали в рапортино → склад", () => {
  ...
  // 422, не 404 и не 500: сгрешеният ключ е в ТЯЛОТО на заявката, не в пътя.
  // Един отговор за всеки лош външен ключ — непознат или на друга фирма.
  test("артикул с непознат идентификатор е 422, не 500", async () => {
