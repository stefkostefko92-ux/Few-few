...
test("шест цифри и прозорец от един интервал", () => {
  // Шест цифри са това, което всяко приложение за втори фактор показва.
  // Прозорецът е ЕДИН интервал в двете посоки: по-широк удължава живота на
