...
/**
 * Потребител на ниво MASTER (върхът на администрацията) е извън обхвата на всеки, който не е
 ...
 * го необратимо (заключва върховния администратор навън завинаги) и изнасяше IP-тата му.
