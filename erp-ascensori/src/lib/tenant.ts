 ...
 *
 * MASTER е върхът на администрацията на фирмата (не външно лице): отговаря за
 * цялата инсталация, включително когато тя държи няколко фирми (напр. на една
 * група) — затова вижда всичко. Всеки друг, включително ADMIN, е
