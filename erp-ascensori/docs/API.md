...
7. **Ротация на `AUDIT_HMAC_KEY`.** Подписът версионира формата (`versioneFirma`),
   но не и ключа: смяна на ключа прави досегашния регистър непроверим. Ротация
   изисква приемане на предишен ключ **при проверка**.
