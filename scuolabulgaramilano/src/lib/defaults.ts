...
export const DEFAULT_CONTENT: DefaultRow[] = [
  ...
  },
  {
    ...
    bg: {
      ...
      stat: "11",
      statLabel: "години до българската общност",
    },
    en: {
  ...
  },
  {
    ...
    bg: {
      ...
      features: [
        ...
        { title: "Призната качественост", text: "Работим по учебници и програми, одобрени от Министерството, с дипломи, признати в България." },
      ],
    },
    en: {
      eyebrow: "About us",
  ...
  },
  {
    ...
    bg: {
      ...
      body: "Освен че пазят културното наследство, танците са полезни за тялото и ума: намаляват стреса, тонизират и създават общност около хорото — традиционния танц в кръг. Посрещаме деца и възрастни, български семейства и италиански участници. Една записване дава достъп до двете седмични занятия.",
