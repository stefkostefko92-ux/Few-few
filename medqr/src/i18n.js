...
const DICT = {
  ...
  'emerg.allergies': { bg: 'Алергии', en: 'Allergies' },
  ...
  'dash.allergies': { bg: 'Алергии', en: 'Allergies' },
  ...
  'err.bad_email': {
    bg: 'Моля, въведете валиден имейл за спешния контакт.',
    en: 'Please enter a valid emergency contact email.',
  },
