...
## AUTO_RULES (прагове от проучването)
- Pause: CPA > 1.5-3× target, 7д lookback, мин. €100 spend, извън learning. Cooldown 24ч.
- Scale: ROAS > target 3+ последователни дни → +20%. Cooldown 72ч.
- Fatigue: frequency > 3.5 или CTR −20% → ротация/нотификация. Cooldown 48ч.
