...
All twenty-three agents have reached at least **v10.0** — mastery — through genuine, source-verified learning
...
matcher to the twenty-three agent types; the schema + `learn`-block format live in `.claude/agents/_memory/PROTOCOL.md`.
