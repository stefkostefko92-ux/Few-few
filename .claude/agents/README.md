...
All eighteen agents have reached **v10.0** — mastery — through genuine, source-verified learning
...
matcher to the eighteen agent types; the schema + `learn`-block format live in `.claude/agents/_memory/PROTOCOL.md`.
