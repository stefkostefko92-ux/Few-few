...
All twenty-one agents have reached at least **v10.0** — mastery — through genuine, source-verified learning
...
matcher to the twenty-one agent types; the schema + `learn`-block format live in `.claude/agents/_memory/PROTOCOL.md`.
