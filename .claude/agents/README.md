...
All sixteen agents have reached **v10.0** — mastery — through genuine, source-verified learning
...
matcher to the sixteen agent types; the schema + `learn`-block format live in `.claude/agents/_memory/PROTOCOL.md`.
