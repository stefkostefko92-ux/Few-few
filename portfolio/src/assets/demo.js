...
(function () {
  ...
  function show(n) { i = (n + items.length) % items.length; img.src = items[i].getAttribute("href"); img.alt = items[i].querySelector("img").alt; lb.hidden = false; document.body.style.overflow = "hidden"; }
