...
export const COMMAND_CATALOG = [
  ...
  // ═══ PANELS ═══
  {
    ...
    commands: [
      { name: "/panel",  signature: "/panel spawn <name>",
  ...
  // ═══ SERVER ADMIN ═══
  {
    ...
    commands: [
      { name: "/premium", signature: "/premium",
        ...
        permission: "Everyone" },
      { name: "/premium custombot", signature: "/premium custombot <token>",
        description: "Attach your own white-label bot token (White-label plan).",
        dashboard: "Settings page · Custom Bot section",
        permission: "Manage Server" },
      { name: "/premium export", signature: "/premium export <type>",
        description: "Export server data as CSV (Premium).",
        dashboard: "Premium page · data export",
        permission: "Manage Server" },
