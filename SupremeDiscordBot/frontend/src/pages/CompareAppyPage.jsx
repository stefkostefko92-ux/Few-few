// frontend/src/pages/CompareAppyPage.jsx
// Public, unauthenticated comparison page — "Supreme Bot vs Appy Bot".
// Growth Level-2 (docs/PRODUCT_ROADMAP.md): captures "appy bot alternative"
// search intent. Every competitor claim in growthContent.js was verified live
// against appy.bot on 2026-08-05 (UCPD / Dir. 2006/114/EC discipline —
...
import { APPY_COMPARE, CHECKED_DATE } from "../data/growthContent";

const d = APPY_COMPARE;
  ...
  return (
    <PublicPageLayout crumb="compare / appy bot">
      <Seo
        ...
        path={d.path}
        keywords={["discord application bot", "appy bot alternative", "discord ticket bot", "supreme bot", "discord bot comparison", "carbon stealth"]}
      />

      {/* ═══ Answer-first intro (AEO) ═══ */}
      <div className="cs-card mb-8">
        <h1 className="text-2xl font-bold text-cs-text flex items-center gap-2">
          <CheckCircle2 className="w-6 h-6 text-cs-cyan" /> Supreme Bot vs Appy Bot
        </h1>
