...
## Репетиция за възстановяване

Седмичният timer `supreme-restore-drill.timer` се инсталира автоматично от root `deploy/autodeploy.sh` при всеки успешен деплой (одит 09.08.2026: този документ обещаваше тримесечна ръчна репетиция, а реалната е СЕДМИЧНА и автоматизирана — документът изоставаше от кода в добрата посока).
