# Release 3.0.0 — деплой runbook

Канонично: качваш ZIP в `/root`, пускаш `autodeploy.sh`. Този документ покрива
**еднократните стъпки специфични за 3.0.0** — след тях следващите релийзи са
...
Миграции в този релийз (прилагат се автоматично, доказани срещу чиста база):
