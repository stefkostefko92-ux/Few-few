...
export const COMMAND_CATALOG = [
  ...
  // ═══ SERVER SEASON (v50) ═══
  {
    ...
    commands: [
      ...
      { name: "/companion list", signature: "/companion list",
        description: "Your caught companions with number, rarity and stage. Companions appear in active channels — press Catch first to claim one.",
        dashboard: "Game page · Companions (catalog + who caught what)", permission: "Everyone" },
      { name: "/companion feed", signature: "/companion feed <number> <sparks>",
        description: "Feed sparks to a companion; at 100 and 300 sparks it evolves to its next form.",
        dashboard: "N/A — Discord only", permission: "Everyone" },
      { name: "/companion activate", signature: "/companion activate <number>",
        description: "Show this companion on your /profile.",
        dashboard: "N/A — Discord only", permission: "Everyone" },
      { name: "/companion trade", signature: "/companion trade <user> <mine> <theirs>",
        description: "Offer a one-for-one trade; the other member accepts with a button within 10 minutes.",
        dashboard: "N/A — Discord only", permission: "Everyone" },
      { name: "/companion release", signature: "/companion release <number>",
        description: "Release a companion to free a collection slot (confirmation button).",
        dashboard: "N/A — Discord only", permission: "Everyone" },
      { name: "/quest", signature: "/quest",
        description: "The active server quests (weekly team goals such as messages, /daily claims, voice minutes, poll votes, verifications) with progress and your own contribution. Everyone who contributes is rewarded; the top contributor opens a chest.",
        dashboard: "Game page · Quests & mini-games (start custom quests, cancel, history)", permission: "Everyone" },
      { name: "/spawn", signature: "/spawn [companion] [channel]",
        description: "Spawn a companion right now instead of waiting for activity: a specific one (autocomplete) or a random one, in this or another channel. Same rules as a natural spawn — one at a time per server, the first to press Catch keeps it; Free servers can spawn common/uncommon only, seasonal ones only while their season runs.",
        dashboard: "N/A — Discord only", permission: "Manage Server" },
      { name: "/trivia", signature: "/trivia [source]",
        description: "Start a trivia round in the current channel right now. Four buttons, the first correct answer wins sparks and XP. Scheduled rounds are configured in the dashboard; knowledge-base questions are Premium.",
        dashboard: "Game page · Overview (trivia channel + schedule) · Quests & mini-games (stats)", permission: "Manage Server" },
      { name: "/wyr", signature: "/wyr",
        description: "Would you rather… — posts a two-choice question with 🅰️/🅱️ vote buttons from our SFW bank.",
        dashboard: "N/A — Discord only (Premium)", permission: "Everyone" },
      { name: "/tod", signature: "/tod truth|dare",
        description: "Truth or dare — a random SFW prompt for you from our bank.",
        dashboard: "N/A — Discord only (Premium)", permission: "Everyone" },
    ],
  },
  // ═══ PRIVACY ═══
