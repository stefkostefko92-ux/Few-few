...
export const CMD_DESC_L10N = {
  ...
  daily: {
    bg: "Вземи дневните си искри (Server Season)",
    de: "Hol dir deine täglichen Funken (Server Season)",
    "es-ES": "Reclama tus chispas diarias (Server Season)",
    fr: "Récupère tes étincelles quotidiennes (Server Season)",
    it: "Riscatta le tue scintille giornaliere (Server Season)",
    nl: "Claim je dagelijkse vonken (Server Season)",
    pl: "Odbierz codzienne iskry (Server Season)",
  },
  profile: {
    bg: "Профил на член в Server Season (ниво, искри, серия)",
    de: "Server-Season-Profil eines Mitglieds (Level, Funken, Serie)",
    "es-ES": "Perfil de Server Season de un miembro (nivel, chispas, racha)",
    fr: "Profil Server Season d'un membre (niveau, étincelles, série)",
    it: "Profilo Server Season di un membro (livello, scintille, serie)",
    nl: "Server Season-profiel van een lid (level, vonken, reeks)",
    pl: "Profil Server Season członka (poziom, iskry, seria)",
  },
  leaderboard: {
    bg: "Топ членовете на сървъра този сезон",
    de: "Die Top-Mitglieder dieses Servers in der Season",
    "es-ES": "Los mejores miembros del servidor esta temporada",
    fr: "Les meilleurs membres du serveur cette saison",
    it: "I migliori membri del server in questa stagione",
    nl: "Topleden van deze server dit seizoen",
    pl: "Najlepsi członkowie serwera w tym sezonie",
  },
  shop: {
    bg: "Похарчи искрите си в магазина на сървъра",
    de: "Gib deine Funken im Server-Shop aus",
    "es-ES": "Gasta tus chispas en la tienda del servidor",
    fr: "Dépense tes étincelles dans la boutique du serveur",
    it: "Spendi le tue scintille nel negozio del server",
  ...
  quest: {
    bg: "Активните сървърни куестове и твоят принос",
    de: "Die aktiven Server-Quests und dein Beitrag",
    "es-ES": "Las misiones del servidor activas y tu aporte",
    fr: "Les quêtes du serveur actives et ta contribution",
    it: "Le missioni del server attive e il tuo contributo",
  ...
  trivia: {
    ...
    "es-ES": "Inicia una ronda de trivia en este canal ahora (Gestionar servidor)",
    fr: "Lance une manche de trivia dans ce salon maintenant (Gérer le serveur)",
    it: "Avvia ora un round di trivia in questo canale (Gestire il server)",
    nl: "Start nu een triviaronde in dit kanaal (Server beheren)",
    pl: "Uruchom rundę trivia na tym kanale teraz (Zarządzanie serwerem)",
  },
  wyr: {
    bg: "Би ли предпочел… — бърз въпрос с два избора за канала",
    de: "Würdest du lieber… — eine schnelle Zwei-Optionen-Frage für den Kanal",
    "es-ES": "¿Qué preferirías…? — una pregunta rápida de dos opciones para el canal",
    fr: "Tu préfères… — une question rapide à deux choix pour le salon",
    it: "Preferiresti… — una domanda rapida a due scelte per il canale",
    nl: "Wat zou je liever… — een snelle vraag met twee keuzes voor het kanaal",
    pl: "Co byś wolał(a)… — szybkie pytanie z dwiema opcjami dla kanału",
  },
  tod: {
    bg: "Истина или предизвикателство — случайна задача за теб",
    de: "Wahrheit oder Pflicht — eine zufällige Aufgabe für dich",
    "es-ES": "Verdad o reto — una consigna aleatoria para ti",
    fr: "Action ou vérité — un défi aléatoire pour toi",
    it: "Obbligo o verità — una sfida casuale per te",
    nl: "Doen of durven — een willekeurige opdracht voor jou",
    pl: "Prawda czy wyzwanie — losowe zadanie dla Ciebie",
  },
  premium: {
