...
|---|---|---|
| **Отмяна** (клиентът спира подновяването) | остава до **края на платения период** | `Server.accessUntil` = край на периода, `Server.gracePlan` = платената тарифа; `plan` пада на `free` |
