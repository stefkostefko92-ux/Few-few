...
export const COMMAND_CATALOG = [
  ...
  // ═══ PANELS ═══
  {
    ...
    commands: [
      ...
      { name: "/setup",  signature: "/setup",
        description: "Interactive quick-start wizard for first-time setup.",
  ...
  // ═══ FORMS & APPLICATIONS ═══
  {
    ...
    commands: [
      { name: "/form",   signature: "/form <name>",
        description: "Spawn an existing form panel in the current channel.",
  ...
  // ═══ SERVER ADMIN ═══
  {
    ...
    dashboardOnly: [
      ...
      { feature: "AI Auto-Replies (Premium)",
        description: "Claude-powered first-response suggestions in new tickets.",
