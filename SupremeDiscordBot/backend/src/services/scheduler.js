...
// ─── Job 7 (v2.0–v3.2): trial-expiry-dm — ПРЕМАХНАТ (v3.3) ────────────────────
// Продуктът вече няма пробен период (решение на собственика, 12.09.2026 —
// Discord Premium Apps също не поддържа trial). Заварените `trialEndsAt` се
// зачитат само на четене в lib/premium.js до естественото им изтичане.
