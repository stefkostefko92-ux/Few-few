...
const STR = {
  en: {
    ...
    endLine: 'Every plate, flame and texture is generated by code. Body motion: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
  ...
  bg: {
    ...
    endLine: 'Всяка плоча, пламък и текстура са генерирани от код. Движение на тялото: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
  ...
  it: {
    ...
    endLine: 'Ogni piastra, fiamma e texture è generata dal codice. Movimento del corpo: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
