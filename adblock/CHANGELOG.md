...
- **Поправка:** броячът на значката и статистиката вече не замръзват при много табове.
  `getMatchedRules` е квотиран (20 извиквания / 10 мин без user gesture); опресняването стои
  под 18 и при изчерпване се отлага, вместо грешката да се глътне тихо.
