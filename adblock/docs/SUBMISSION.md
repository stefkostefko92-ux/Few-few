...
```bash
bash tools/package.sh      # → dist/supreme-adblock-5.0.1.zip
```
...
1. Open the item → **Package → Upload new package** → `dist/supreme-adblock-5.0.1.zip`.
...
- [ ] `manifest.json` and `package.json` versions match (5.0.1)
