...
```bash
bash tools/package.sh      # → dist/supreme-adblock-5.0.2.zip
```
...
1. Open the item → **Package → Upload new package** → `dist/supreme-adblock-5.0.2.zip`.
...
- [ ] `manifest.json` and `package.json` versions match (5.0.2)
