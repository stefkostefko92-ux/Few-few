...
Четири проверки, всяка fail-closed:
...
4. Всеки ключ в каталога се употребява (от кода или от изброяване) — неизползваният
   ключ е мъртъв превод, който Преводачът поддържа напразно.
