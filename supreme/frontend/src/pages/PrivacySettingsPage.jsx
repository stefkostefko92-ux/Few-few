...
export default function PrivacySettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Privacy & Your Data</h1>
      ...
      <section className="cs-card mb-6">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-white mb-1">Export your data</h2>
      ...
      <section className="cs-card mb-6">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-white mb-1">Subprocessors</h2>
            <p className="text-sm text-cs-muted mb-3">
            ...
            <ul className="text-xs text-cs-muted space-y-2">
              <li className="flex justify-between border-b border-cs-border pb-2">
                <span><strong className="text-white">Hetzner Online GmbH</strong> — Hosting (EU, Germany)</span>
                <a href="https://www.hetzner.com/legal/privacy-policy/" target="_blank" rel="noopener" className="text-cs-cyan">Policy →</a>
              </li>
              <li className="flex justify-between border-b border-cs-border pb-2">
                <span><strong className="text-white">Stripe Payments Europe Ltd</strong> — Payment processing (EU, Ireland)</span>
                <a href="https://stripe.com/privacy" target="_blank" rel="noopener" className="text-cs-cyan">Policy →</a>
              </li>
              <li className="flex justify-between border-b border-cs-border pb-2">
                <span><strong className="text-white">Anthropic PBC</strong> — AI auto-replies (USA, SCC safeguards)</span>
                <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener" className="text-cs-cyan">Policy →</a>
              </li>
              <li className="flex justify-between">
                <span><strong className="text-white">Discord Inc.</strong> — Authentication + bot API (USA, SCC safeguards)</span>
      ...
      <section className="cs-card mb-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-white mb-1">Legal documents</h2>
