...
const STRINGS: Record<string, ReceiptStrings> = {
  bg: {
    ...
    vatNote:
      'Продавачът е търговец на официалната си документация. Linketto е платформа-посредник; продавачът е доставчик на съдържанието и носи отговорността за ДДС и данъчна фактура, ако такава се дължи.',
