...
0. **ДАНЪЦИ (нов, 2026-07-10 — виж [`TAX.md`](TAX.md)):** по чл. 9а
   Регл. 282/2011 **платформата е ДДС длъжник за продажбите в магазина**
   (deemed supplier, необоримо при нашата архитектура; C-695/20 Fenix).
   **Магазинът НЕ тръгва на живо преди:** жив данъчен консултант потвърди
   (чл. 9а + чл. 97а + OSS/микропраг), регистрации в НАП, Stripe Tax слой
   в кода. Плановете може по-рано (наша услуга, микропраг €10 000) — пак
   след данъчния.
