# millelink/ — многоезичният „link in bio“

Millelink е глобален конкурент на Linktree: една публична страница
...
## Команди (изпълнявай в `millelink/`)
...
src/app/(public)/u/[slug]/ Публичен профил: език = ?hl → Accept-Language →
    ...
    .../l/[linkId]/route.ts  Клик: запис на ClickEvent + 302 redirect.
