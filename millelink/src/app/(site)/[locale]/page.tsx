        ...
        <section className="py-20 text-center">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <Link
              ...
              className="rounded-full bg-millelink-600 px-6 py-3 font-semibold text-white hover:bg-millelink-700"
            >
              {t('ctaPrimary')}
            </Link>
            <a
        ...
        <section aria-labelledby="features">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((key) => (
              ...
              >
                <h3 className="font-semibold text-millelink-700">
                  {t(`feature${key}Title`)}
                </h3>
            ...
            {PLAN_ORDER.map((planKey) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-millelink-600">
                  ...
                  <Link
                    href={`/${locale}/register`}
                    className="mt-6 rounded-full border border-millelink-600 px-4 py-2 text-center text-sm font-semibold text-millelink-700 hover:bg-millelink-50"
                  >
                    {tPricing('choose')}
                  </Link>
                </div>
