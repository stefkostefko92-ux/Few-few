...
/**
 * Pezzi di interfaccia riusati dalle pagine del modulo. Non sono primitive
 * generiche (quelle stanno in `@/components/ui`): sono composizioni specifiche
 * di prodotti, giacenze e ubicazioni.
 */
