...
const STR = {
  en: {
    ...
    endLine: 'Armour, fire and courtyard are generated by code. Heads: the “Infinite” 3D head scan by Lee Perry-Smith (triplegangers.com), CC BY 3.0 (creativecommons.org/licenses/by/3.0), adapted. Body motion: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
    ...
    shot: 'Shot',
    stats: 'Stats',
    fatal: 'Neither WebGPU nor WebGL 2 is available in this browser. Open the page in a current Chrome, Edge, Firefox or Safari.',
  ...
  bg: {
    ...
    endLine: 'Доспехите, огънят и дворът са генерирани от код. Глави: 3D сканът „Infinite“ на Lee Perry-Smith (triplegangers.com), CC BY 3.0 (creativecommons.org/licenses/by/3.0), преработен. Движение на тялото: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
    ...
    shot: 'Кадър',
    stats: 'Статистика',
    fatal: 'Нито WebGPU, нито WebGL 2 е наличен в този браузър. Отворете страницата в актуален Chrome, Edge, Firefox или Safari.',
  ...
  it: {
    ...
    endLine: 'Armature, fuoco e cortile sono generati dal codice. Teste: scansione 3D «Infinite» di Lee Perry-Smith (triplegangers.com), CC BY 3.0 (creativecommons.org/licenses/by/3.0), adattata. Movimento del corpo: CMU Graphics Lab Motion Capture Database (mocap.cs.cmu.edu, NSF EIA-0196217).',
    ...
    shot: 'Inquadratura',
    stats: 'Statistiche',
    fatal: 'Né WebGPU né WebGL 2 sono disponibili in questo browser. Apri la pagina con Chrome, Edge, Firefox o Safari aggiornati.',
...
export function createHud(h) {
  ...
  return {
    ...
    stats(st) {
      ...
      $('st-tier').textContent = `${st.tier} · ${st.backend}`;
    },
    setTicks(list) {
      const box = $('ticks');
      box.textContent = '';
