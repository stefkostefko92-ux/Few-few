...
// градиент, highlight-а (::before), вътрешното сияние (::after) и меките сенки.
// БЕЗ backdrop-filter на капките — 9 движещи се семплъра на размазания фон бяха
// причината за лага (виж .viv-drop в globals.css); визуалната загуба е нулева.
