    ...
    <article className="prose-warm mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mt-8 space-y-6 text-ink-soft [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-ink">
        ...
        <div>
          ...
          <p className="mt-2">
            Мастилко не използва бисквитки, аналитични инструменти, рекламни
            мрежи или социални приставки. Затова няма и банер за съгласие —
            няма за какво да искаме съгласие.
          </p>
        </div>
