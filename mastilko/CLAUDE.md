...
- **Нищо потребителско не отива на сървъра**, освен при изричен клик върху AI
  ...
  **Правен ангажимент (одит 2026-07):** условията на Gemini API изискват
  **Paid tier за потребители от ЕИП** (на free tier Google може да тренира
  върху заявките + човешки преглед) — продукционният ключ да е с включен
  billing; `/poveritelnost` описва трансфера (DPF/SCC) и предупреждава „без
  лични данни в AI полетата“. Не отслабвай тези текстове.
