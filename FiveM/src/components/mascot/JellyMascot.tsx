// КОПИЕ от пакета `mascot/` в корена на монорепото (продуктите копират каквото
// ползват — маскот пакетът е zero-dep и не се инсталира). Не редактирай тук:
// поправката отива в `mascot/svg/*` + `node mascot/build.mjs`, после копирай пак.
