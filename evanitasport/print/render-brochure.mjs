// Превръща brochure-a5.html в готов за печат PDF (A5, 2 страници — лице и гръб)
// и в PNG прегледи на двете страни. Изисква: npm i playwright (+ chromium).
...
console.log("Написах brochure-a5.pdf + PNG прегледи");
await b.close();
