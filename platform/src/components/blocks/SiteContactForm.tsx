    ...
    <div className="mx-auto w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
      ...
      {state.ok ? (
        ...
        <form action={formAction} className="mt-4 space-y-3">
          ...
          >
            {pending ? "Изпращане…" : buttonLabel}
          </button>
          {/* Прозрачност по GDPR (чл. 13): цел, основание, съхранение. */}
          <p className="text-xs leading-relaxed text-slate-500">
            С изпращането предоставяте името и имейла си, за да можем да отговорим на запитването ви.
            Обработваме данните само за тази цел (законен интерес, чл. 6, § 1, б. „е“ GDPR), не ги
            предаваме на трети страни за маркетинг и ги пазим ограничен период. Имате право на достъп,
            коригиране и изтриване.
          </p>
          {disabled && (
            <p className="text-xs text-slate-400">
              (Превю — формата работи на публикувания сайт.)
            </p>
          )}
        </form>
      )}
