...
| **Аларми** | известия на телефона (Telegram / ntfy / webhook / имейл) при диск/CPU/памет праг, паднала услуга, продукт DOWN, изтичащ сертификат, провален деплой; прагове и канали от интерфейса |
