...
| `boy/` | Двубой в Рейвънхолд — кинематографичен средновековен двубой в реално време в браузъра (рицари, дъжд, огън, bullet-time) | three.js r186 (WebGL 2) · plain JS ESM · esbuild → един HTML · процедурни асети, нула модели/изображения | EN/BG/IT · демо, **не** продукт с деплой · 60 fps регулатор на резолюцията · тестове със симулация на целия двубой |
