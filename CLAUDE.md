...
| `erp-ascensori/` | ERP Ascensori Enterprise — гестионал за асансьорни фирми (импианти, срокове, склад, preventivi, ordini, фактури, DDT, персонализируемо табло) | Next.js 15 · React 19 · TS · Prisma · PostgreSQL · Tailwind · Recharts | IT · 42 таблици · 7 нива достъп · HMAC audit |
