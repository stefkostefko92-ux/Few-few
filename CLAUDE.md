...
| `publikator/` | Публикатор — Instagram контент-двигател (чернова → човешко одобрение → публикуване) | Node 22 · TS strict (ESM) · Express 5 · Prisma · PostgreSQL · BullMQ + Redis · Anthropic SDK | BG · официален Instagram Platform API · акаунти се създават **ръчно** (ToS на Meta) |
