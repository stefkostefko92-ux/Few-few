...
| `LaTuaAuto/` | LaTuaAuto — чат по табела + самопопълващи се срокове за автомобила (адаптация на KolataTi за Италия) | Next.js 15 · React 19 · TS · Prisma · PostgreSQL · Tailwind · next-intl | IT/EN/DE · latuaauto.carbonstealth.eu · табелата е лична данна; непотвърдено владение не получава; проучване в `research/targa-italia/` |
