...
| `ospedali/` | Ospedali Trasparenti — ETL за финансите на публичните болници в Италия (BDAP/MEF + dati.salute) | Node ≥20 · plain JS ESM · нула зависимости | отчет за всяка SSN структура · официални open data |
