...
| `deja/` | Déjà — локална семантична памет на браузъра (търсиш каквото си чел по смисъл) | Chrome MV3 (+Firefox build) · plain JS ESM · esbuild · transformers.js ONNX/WASM · IndexedDB | BG/EN/IT · 100% локално, нула cloud · deja.carbonstealth.eu · Chrome Web Store |
