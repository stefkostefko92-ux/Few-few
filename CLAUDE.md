...
| `karakochev/` | Каракочев — лични записки с напомняне (iOS) | Swift 6 · SwiftUI · SwiftData · UserNotifications · iOS 17+ · Foundation-only ядро, тествано на Linux | BG/EN/IT (езикът на телефона) · само локални известия, нула мрежа · бързо добавяне от текст · Siri · износ/внос · неподписан `.ipa` от CI, подписва се с Apple ID на собственика |
