...
| `portfolio/` | Carbon Stealth Portfolio — 10 демо лендинг страници (сервиз · фитнес · мебели · адвокати · салон · хотел · счетоводство · автокъща · дрехи · бързо хранене) + цени/пакети | Node ≥20 генератор · нула зависимости · статичен `dist/` зад Nginx | BG/EN/IT · portfolio.carbonstealth.eu · цени ≥15% под пазара · reverse charge за ЕС фирми |
