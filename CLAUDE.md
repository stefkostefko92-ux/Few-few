...
| `portfolio/` | Carbon Stealth Portfolio — 10 демо лендинг страници (сервиз · фитнес · мебели · адвокати · салон · хотел · счетоводство · автокъща · дрехи · бързо хранене) + цени/пакети | Node ≥20 генератор · нула runtime зависимости · статичен `dist/` зад Nginx · self-hosted шрифтове · снимки CC BY 2.0 (`portfolio/tools/photos.mjs`) | BG/EN/IT · portfolio.carbonstealth.eu · дизайн езикът на carbonstealth.eu · цени ≥15% под пазара · reverse charge за ЕС фирми |
