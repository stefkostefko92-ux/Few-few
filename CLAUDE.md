...
| `ospedali/` | Ospedali Trasparenti — ETL + статичен сайт за финансите на публичните болници в Италия (BDAP/MEF + dati.salute) | Node ≥20 · plain JS ESM · нула зависимости | IT · сайт + отчет за всяка SSN структура · автоматични сигнали за аномалии · официални open data |
