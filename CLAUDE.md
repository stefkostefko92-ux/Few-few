...
| `boy/` | Двубой в Рейвънхолд — кинематографичен средновековен двубой в реално време в браузъра (рицари, дъжд, огън, bullet-time) | three.js r186 (WebGPU + TSL, резервно WebGL 2) · plain JS ESM · esbuild → един HTML · процедурни доспехи, изпечени 2–4K PBR текстури, motion capture (CMU) | EN/BG/IT · демо, **не** продукт с деплой · TRAA/SSGI/SSR/DOF/motion blur конвейер · 60 fps регулатор на резолюцията · тестове със симулация на целия двубой |
