// Печатен handoff към mastilko-bg.com: подписан кратко-живеещ токен + API payload.
// Потребителят отива на mastilko с токен; mastilko вика нашето API, за да изтегли
// структурираните данни на визитката за детайлна обработка (дизайн/поръчка).
