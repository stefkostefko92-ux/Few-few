  ...
  const docs = [
    {
      ...
      text: [
        ...
        'Какво Vizitka НЕ прави: не е CRM и не събира контактите на сканиращите; не продава и не програмира NFC чипове (таблото дава адреса за запис в NTAG213/215 чип, записът е от потребителя); един акаунт носи една визитка; не продава печат.',
        FAQ.map((f) => `В: ${f.q}\nО: ${f.a}`).join('\n\n'),
      ].join('\n\n'),
    },
  ];
