...
export const HEADER_KEY_ID = 'x-piuma-key-id';
export const HEADER_TIMESTAMP = 'x-piuma-timestamp';
export const HEADER_NONCE = 'x-piuma-nonce';
export const HEADER_SIGNATURE = 'x-piuma-signature';
